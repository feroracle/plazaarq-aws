...
if (!class_exists('EntreMikadoTopNavigationWalker')) {
	class EntreMikadoTopNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($item->hide == ""){
				...
				if($args->has_children && $depth == 0) {
					$item_output .= '<i class="mkd-menu-arrow arrow_carrot-down"></i>';
				}
