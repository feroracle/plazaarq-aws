...
if ( $row_content_width !== 'grid' ) {
	...
	if (!empty($parallax_background_image)) {
		...
		$css_classes[] = 'mkd-parallax-row-holder';
	...
	if (!empty($parallax_background_image)) {
		...
		$grid_row_class[] = 'mkd-parallax-row-holder';
...
if($row_content_width === 'grid'){
	$mkd_row_wrapper_start .= '<div class="mkd-row-grid-section-wrapper '.esc_attr($grid_row_classes).'" '.esc_attr($grid_row_datas).' ' . entre_mikado_get_inline_style( $mkd_grid_row_styles ) . '><div class="mkd-row-grid-section">';
...
$output .= '<div ' . implode( ' ', $wrapper_attributes ) . ' ' . entre_mikado_get_inline_style( $mkd_vc_row_styles ) . '>';
$output .= wpb_js_remove_wpautop( $content );
$output .= '</div>';
$output .= $mkd_row_wrapper_end;
$output .= $after_output;

print entre_mikado_display_content_output($output);
