...
if($row_content_width === 'grid'){
	$mkd_row_wrapper_start .= '<div class="mkd-row-grid-section-wrapper '.esc_attr($grid_row_classes).'" ' . entre_mikado_get_inline_style( $mkd_grid_row_styles ) . '><div class="mkd-row-grid-section">';
