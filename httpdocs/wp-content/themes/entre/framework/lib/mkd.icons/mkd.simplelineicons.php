...
class EntreMikadoSimpleLineIcons implements iEntreMikadoIconCollection {
    ...
    public function render($icon, $params = array()) {
        ...
        $iconClass = '';
        if (isset($icon_attributes) && is_array($icon_attributes) && count($icon_attributes)) {
        ...
        if (isset($before_icon) && $before_icon !== '') {
            ...
            if (isset($before_icon_attributes) && is_array($before_icon_attributes) && count($before_icon_attributes)) {
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'entre'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'entre'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'entre'),
            'icon-social-facebook'    => esc_html__('Facebook', 'entre'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'entre'),
            'icon-social-github'      => esc_html__('Github', 'entre'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'entre'),
            'icon-social-instagram'   => esc_html__('Instagram', 'entre'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'entre'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'entre'),
            'icon-social-reddit'      => esc_html__('Reddit', 'entre'),
            'icon-social-skype'       => esc_html__('Skype', 'entre'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'entre'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'entre'),
            'icon-social-spotify'     => esc_html__('Spotify', 'entre'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'entre'),
            'icon-social-twitter'     => esc_html__('Twitter', 'entre'),
            'icon-social-youtube'     => esc_html__('Youtube', 'entre')
        );
    }
