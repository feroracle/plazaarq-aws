...
/*
   Class: EntreMikadoMultipleImages
   A class that initializes Mikado Multiple Images
*/

class EntreMikadoMultipleImages implements iEntreMikadoRender {
	private $name;
	private $label;
	private $description;
	...
	function __construct( $name, $label = "", $description = "" ) {
		...
		$entre_mikado_Framework->mkdMetaBoxes->addOption( $this->name, "" );
	}
					...
					<div class="row">
						<div class="col-lg-12">
							...
							<div class="mkd-gallery-uploader">
								<a class="mkd-gallery-upload-btn btn btn-sm btn-primary" href="javascript:void(0)"><?php esc_html_e( 'Upload', 'entre' ); ?></a>
								<a class="mkd-gallery-clear-btn btn btn-sm btn-default pull-right" href="javascript:void(0)"><?php esc_html_e( 'Remove All', 'entre' ); ?></a>
							</div>
						</div>
					</div>
				</div>
...
/*
   Class: EntreMikadoImagesVideos
   A class that initializes Mikado Images Videos
*/
class EntreMikadoImagesVideos implements iEntreMikadoRender {
	private $label;
	private $description;
	...
	public function render( $factory ) {
			...
			<div class="mkd-page-form-section">
				...
				<div class="mkd-section-content">
					<div class="container-fluid">
						<div class="row">
							<div class="col-lg-2">
								<em class="mkd-field-description"><?php esc_html_e( 'Order Number', 'entre' ); ?></em>
						...
						<div class="row next-row">
							<div class="col-lg-12">
								<em class="mkd-field-description"><?php esc_html_e( 'Image', 'entre' ); ?></em>
								<div class="mkd-media-uploader">
									<div style="display: none" class="mkd-media-image-holder">
										<img src="" alt="<?php esc_attr_e( 'Image thumbnail', 'entre' ); ?>" class="mkd-media-image img-thumbnail"/>
									</div>
						...
						<div class="row next-row">
							<div class="col-lg-3">
								<em class="mkd-field-description"><?php esc_html_e( 'Video Type', 'entre' ); ?></em>
								<select class="form-control mkd-form-element mkd-portfoliovideotype" name="portfoliovideotype_x" id="portfoliovideotype_x">
									<option value=""></option>
									<option value="youtube"><?php esc_html_e( 'YouTube', 'entre' ); ?></option>
									<option value="vimeo"><?php esc_html_e( 'Vimeo', 'entre' ); ?></option>
									<option value="self"><?php esc_html_e( 'Self Hosted', 'entre' ); ?></option>
								</select>
							</div>
							<div class="col-lg-3">
								<em class="mkd-field-description"><?php esc_html_e( 'Video ID', 'entre' ); ?></em>
								<input type="text" class="form-control mkd-input mkd-form-element" id="portfoliovideoid_x" name="portfoliovideoid_x"/>
							</div>
						</div>
						<div class="row next-row">
							<div class="col-lg-12">
								<em class="mkd-field-description"><?php esc_html_e( 'Video image', 'entre' ); ?></em>
								<div class="mkd-media-uploader">
									<div style="display: none" class="mkd-media-image-holder">
										<img src="" alt="<?php esc_attr_e( 'Image thumbnail', 'entre' ); ?>" class="mkd-media-image img-thumbnail"/>
									</div>
						...
						<div class="row next-row">
							<div class="col-lg-4">
								<em class="mkd-field-description"><?php esc_html_e( 'Video mp4', 'entre' ); ?></em>
								<input type="text" class="form-control mkd-input mkd-form-element" id="portfoliovideomp4_x" name="portfoliovideomp4_x"/>
							</div>
						</div>
						<div class="row next-row">
							<div class="col-lg-12">
								<a class="mkd_remove_image btn btn-sm btn-primary" href="/" onclick="javascript: return false;"><?php esc_html_e( 'Remove portfolio image/video', 'entre' ); ?></a>
							</div>
						</div>
					</div>
				</div>
		...
		if ( is_array( $portfolio_images ) && count( $portfolio_images ) > 1 && entre_mikado_core_plugin_installed() ) {
								...
								<div class="col-lg-12">
									...
									<div class="mkd-media-uploader">
										<div<?php if ( stripslashes( $portfolio_image['portfolioimg'] ) == false ) { ?> style="display: none"<?php } ?> class="mkd-media-image-holder">
											<img src="<?php if ( stripslashes( $portfolio_image['portfolioimg'] ) == true ) { echo esc_url( entre_mikado_get_attachment_thumb_url( stripslashes( $portfolio_image['portfolioimg'] ) ) ); } ?>" alt="<?php esc_attr_e( 'Image thumbnail', 'entre' ); ?>" class="mkd-media-image img-thumbnail"/>
										</div>
										<div style="display: none" class="mkd-media-meta-fields">
							...
							<div class="row next-row">
								<div class="col-lg-3">
									...
									<select class="form-control mkd-form-element mkd-portfoliovideotype" name="portfoliovideotype[]" id="portfoliovideotype_<?php echo esc_attr( $no ); ?>">
										<option value=""></option>
										<option <?php if ( $portfolio_image['portfoliovideotype'] == "youtube" ) { echo "selected='selected'"; } ?> value="youtube"><?php esc_html_e( 'YouTube', 'entre' ); ?></option>
										<option <?php if ( $portfolio_image['portfoliovideotype'] == "vimeo" ) { echo "selected='selected'"; } ?> value="vimeo"><?php esc_html_e( 'Vimeo', 'entre' ); ?></option>
										<option <?php if ( $portfolio_image['portfoliovideotype'] == "self" ) { echo "selected='selected'"; } ?> value="self"><?php esc_html_e( 'Self Hosted', 'entre' ); ?></option>
									</select>
								</div>
								<div class="col-lg-3">
									<em class="mkd-field-description"><?php esc_html_e( 'Video ID', 'entre' ); ?></em>
								...
								<div class="col-lg-12">
									...
									<div class="mkd-media-uploader">
										<div<?php if ( stripslashes( $portfolio_image['portfoliovideoimage'] ) == false ) { ?> style="display: none"<?php } ?> class="mkd-media-image-holder">
											<img src="<?php if ( stripslashes( $portfolio_image['portfoliovideoimage'] ) == true ) { echo esc_url( entre_mikado_get_attachment_thumb_url( stripslashes( $portfolio_image['portfoliovideoimage'] ) ) ); } ?>" alt="<?php esc_attr_e( 'Image thumbnail', 'entre' ); ?>" class="mkd-media-image img-thumbnail"/>
										</div>
										<div style="display: none" class="mkd-media-meta-fields">
		...
		?>
		<br/>
		<a class="mkd_add_image btn btn-sm btn-primary" onclick="javascript: return false;" href="/"><?php esc_html_e( 'Add portfolio image/video', 'entre' ); ?></a>
		<?php
	}
}
...
class EntreMikadoImagesVideosFramework implements iEntreMikadoRender {
	private $label;
	private $description;
	...
	public function render( $factory ) {
		...
		<div class="mkd-hidden-portfolio-images" style="display: none">
			<div class="mkd-portfolio-toggle-holder">
				<div class="mkd-portfolio-toggle mkd-toggle-desc">
					...
					<span class="mkd-toggle-inner"><?php esc_html_e( 'Image - ', 'entre' ); ?><em><?php esc_html_e( 'Order Number', 'entre' ); ?></em></span>
				</div>
							...
							<div class="row">
								<div class="col-lg-2">
									<div class="mkd-media-uploader">
										...
										<a class="mkd-media-upload-btn btn btn-sm btn-primary" href="javascript:void(0)" data-frame-title="<?php esc_attr_e( 'Select Image', 'entre' ); ?>" data-frame-button-text="<?php esc_attr_e( 'Select Image', 'entre' ); ?>"><?php esc_html_e( 'Upload', 'entre' ); ?></a>
										<a style="display: none;" href="javascript: void(0)" class="mkd-media-remove-btn btn btn-default btn-sm"><?php esc_attr_e( 'Remove', 'entre' ); ?></a>
									</div>
								</div>
								<div class="col-lg-2">
									<em class="mkd-field-description"><?php esc_html_e( 'Order Number', 'entre' ); ?></em>
		...
		<div class="mkd-hidden-portfolio-videos" style="display: none">
			<div class="mkd-portfolio-toggle-holder">
				<div class="mkd-portfolio-toggle mkd-toggle-desc">
					...
					<span class="mkd-toggle-inner"><?php esc_html_e( 'Video - ', 'entre' ); ?><em><?php esc_html_e( 'Order Number', 'entre' ); ?></em></span>
				</div>
				<div class="mkd-portfolio-toggle mkd-portfolio-control">
					<span class="toggle-portfolio-media"><i class="fa fa-caret-up"></i></span>
					<a href="#" class="remove-portfolio-media"><i class="fa fa-times"></i></a>
					...
					<div class="mkd-section-content">
						<div class="container-fluid">
							<div class="row">
								<div class="col-lg-2">
									<div class="mkd-media-uploader">
										<em class="mkd-field-description"><?php esc_html_e( 'Cover Video Image', 'entre' ); ?></em>
										<div style="display: none" class="mkd-media-image-holder">
											<img src="" alt="<?php esc_attr_e( 'Image thumbnail', 'entre' ); ?>" class="mkd-media-image img-thumbnail">
										</div>
										<div style="display: none" class="mkd-media-meta-fields">
								...
								<div class="col-lg-10">
									...
									<div class="row next-row">
										...
										<div class="col-lg-2 mkd-video-id-holder">
											<em class="mkd-field-description" id="videoId"><?php esc_html_e( 'Video ID', 'entre' ); ?></em>
											<input type="text" class="form-control mkd-input mkd-form-element" id="portfoliovideoid_x" name="portfoliovideoid_x">
										</div>
									</div>
			...
			if ( $portfolio_img_type == "image" ) { ?>
				<div class="mkd-portfolio-images mkd-portfolio-media" rel="<?php echo esc_attr( $no ); ?>">
					<div class="mkd-portfolio-toggle-holder">
						<div class="mkd-portfolio-toggle mkd-toggle-desc">
							...
							<span class="mkd-toggle-inner"><?php esc_html_e( 'Image - ', 'entre' ); ?><em><?php echo stripslashes( $portfolio_image['portfolioimgordernumber'] ); ?></em></span>
						</div>
						<div class="mkd-portfolio-toggle mkd-portfolio-control">
				...
				<div class="mkd-portfolio-videos mkd-portfolio-media" rel="<?php echo esc_attr( $no ); ?>">
					<div class="mkd-portfolio-toggle-holder">
						<div class="mkd-portfolio-toggle mkd-toggle-desc">
							<span class="number"><?php echo esc_html( $no ); ?></span>
							<span class="mkd-toggle-inner"><?php esc_html_e( 'Video - ', 'entre' ); ?><em><?php echo stripslashes( $portfolio_image['portfolioimgordernumber'] ); ?></em></span>
						</div>
						<div class="mkd-portfolio-toggle mkd-portfolio-control">
							<a href="#" class="toggle-portfolio-media"><i class="fa fa-caret-down"></i></a>
							<a href="#" class="remove-portfolio-media"><i class="fa fa-times"></i></a>
		...
		<div class="mkd-portfolio-add">
			<a class="mkd-add-image btn btn-sm btn-primary" href="#"><i class="fa fa-camera"></i><?php esc_html_e( 'Add Image', 'entre' ); ?></a>
			<a class="mkd-add-video btn btn-sm btn-primary" href="#"><i class="fa fa-video-camera"></i><?php esc_html_e( 'Add Video', 'entre' ); ?></a>
			<a class="mkd-toggle-all-media btn btn-sm btn-default pull-right" href="#"><?php esc_html_e( 'Expand All', 'entre' ); ?></a>
		</div>
		<?php
	}
}

class EntreMikadoTwitterFramework implements iEntreMikadoRender {
	public function render( $factory ) {
		...
		if ( ! empty( $_GET['oauth_token'] ) && ! empty( $_GET['oauth_verifier'] ) ) {
			...
			if ( $responseObj->status ) {
				$message = esc_html__( 'You have successfully connected with your Twitter account. If you have any issues fetching data from Twitter try reconnecting.', 'entre' );
			} else {
				$message = $responseObj->message;
			}
		}
		
		$buttonText = $twitterApi->hasUserConnected() ? esc_html__( 'Re-connect with Twitter', 'entre' ) : esc_html__( 'Connect with Twitter', 'entre' );
		?>
		<?php if ( $message !== '' ) { ?>
		...
		<div class="mkd-page-form-section" id="mkd_enable_social_share">
			<div class="mkd-field-desc">
				<h4><?php esc_html_e( 'Connect with Twitter', 'entre' ); ?></h4>
				<p><?php esc_html_e( 'Connecting with Twitter will enable you to show your latest tweets on your site', 'entre' ); ?></p>
			</div>
			<div class="mkd-section-content">
				<div class="container-fluid">
					<div class="row">
...
class EntreMikadoInstagramFramework implements iEntreMikadoRender {
	public function render( $factory ) {
		...
		if ( ! empty( $_GET['code'] ) && ! empty( $_GET['instagram'] ) ) {
			...
			$message = esc_html__( 'You have successfully connected with your Instagram Personal account.', 'entre' );
		}
		...
		if ( ! empty( $_GET['access_token'] ) && ! empty( $_GET['facebook'] ) ) {
			...
			$message = esc_html__( 'You have successfully connected with your Instagram Business account.', 'entre' );
		}
		...
		if ( ! empty( $_GET['disconnect'] ) ) {
			...
			$message = esc_html__( 'You have have been disconnected from all Instagram accounts.', 'entre' );
		...
		<div class="mkd-page-form-section" id="mkd_enable_social_share">
			<div class="mkd-field-desc">
				<h4><?php esc_html_e( 'Connect with Instagram', 'entre' ); ?></h4>
				<p><?php esc_html_e( 'Connecting with Instagram will enable you to show your latest photos on your site', 'entre' ); ?></p>
			</div>
			<div class="mkd-section-content">
				<div class="container-fluid">
					<?php
					...
					if ( $instagram_user_id ) { ?>
						<div class="row">
							<div class="col-lg-12">
								<p><?php echo esc_html__( 'You are currently connected to Instagram ID: ', 'entre' );
					...
					<div class="row">
						<?php if ( ! empty( $_GET['disconnect'] ) ) { ?>
							<div class="col-lg-4">
								<a class="btn btn-primary" href="<?php echo esc_url( $instagram_api->reloadURL() ); ?>"><?php echo esc_html__( 'Reload Page', 'entre' ); ?></a>
							</div>
						<?php } else if ( empty( $connection_type ) ) { ?>
							<div class="col-lg-4">
								<a class="btn btn-primary" href="<?php echo esc_url( $instagram_api->instagramRequestCode() ); ?>"><?php echo esc_html__( 'Connect with Instagram Personal account', 'entre' ); ?></a>
							</div>
							<!-- <div class="col-lg-4">
						...
						<?php } else { ?>
							<div class="col-lg-4">
								<a class="btn btn-primary" href="<?php echo esc_url( $instagram_api->disconnectURL() ); ?>"><?php echo esc_html__( 'Disconnect Instagram account', 'entre' ) ?></a>
							</div>
						<?php } ?>
					</div>
				</div>
...
/*
   ...
   A class that initializes Mikado Images Videos
*/
class EntreMikadoOptionsFramework implements iEntreMikadoRender {
	private $label;
	private $description;
	...
	public function render( $factory ) {
		...
		<div class="mkd-portfolio-additional-item-holder" style="display: none">
			<div class="mkd-portfolio-toggle-holder">
				<div class="mkd-portfolio-toggle mkd-toggle-desc">
					<span class="number">1</span>
					<span class="mkd-toggle-inner"><?php esc_html_e( 'Additional Sidebar Item ', 'entre' ); ?><em><?php esc_html_e( '(Order Number, Item Title)', 'entre' ); ?></em></span>
				</div>
				<div class="mkd-portfolio-toggle mkd-portfolio-control">
					...
					<div class="mkd-section-content">
						<div class="container-fluid">
							<div class="row">
								...
								<div class="col-lg-10">
									<em class="mkd-field-description"><?php esc_html_e( 'Item Title', 'entre' ); ?></em>
									<input type="text" class="form-control mkd-input mkd-form-element" id="optionLabel_x" name="optionLabel_x">
								</div>
							</div>
							<div class="row next-row">
								<div class="col-lg-12">
									<em class="mkd-field-description"><?php esc_html_e( 'Item Text', 'entre' ); ?></em>
									<textarea class="form-control mkd-input mkd-form-element" id="optionValue_x" name="optionValue_x"></textarea>
								</div>
							</div>
							<div class="row next-row">
								<div class="col-lg-12">
									<em class="mkd-field-description"><?php esc_html_e( 'Enter Full URL for Item Text Link', 'entre' ); ?></em>
		...
		if ( is_array( $portfolios ) && count( $portfolios ) > 1 && entre_mikado_core_plugin_installed() ) {
		...
		while ( isset( $portfolios[ $no - 1 ] ) ) {
			...
			<div class="mkd-portfolio-additional-item" rel="<?php echo esc_attr( $no ); ?>">
				<div class="mkd-portfolio-toggle-holder">
					<div class="mkd-portfolio-toggle mkd-toggle-desc">
						<span class="number"><?php echo esc_html( $no ); ?></span>
						<span class="mkd-toggle-inner"><?php esc_html_e( 'Additional Sidebar Item - ', 'entre' ); ?><em>(<?php echo stripslashes( $portfolio['optionlabelordernumber'] ); ?>, <?php echo stripslashes( $portfolio['optionLabel'] ); ?>)</em></span>
					</div>
					<div class="mkd-portfolio-toggle mkd-portfolio-control">
		...
		<div class="mkd-portfolio-add">
			<a class="mkd-add-item btn btn-sm btn-primary" href="#"><?php esc_html_e( 'Add New Item', 'entre' ); ?></a>
			<a class="mkd-toggle-all-item btn btn-sm btn-default pull-right" href="#"><?php esc_html_e( 'Expand All', 'entre' ); ?></a>
		</div>
		<?php
	}
}

class EntreMikadoRepeater implements iEntreMikadoRender {
	private $label;
	private $description;
	private $name;
	private $fields;
	...
	function __construct( $fields, $name, $label = '', $description = '', $button_text = '' ) {
		...
		$this->name        = $name;
		$this->num_of_rows = 1;
		$this->button_text = ! empty( $button_text ) ? $button_text : esc_html__( 'Add New Item', 'entre' );
		...
		foreach ( $this->fields as $field ) {
			...
			$entre_mikado_Framework->mkdMetaBoxes->addOption( $this->fields[ $counter ]['name'], $this->fields[ $counter ]['default_value'] );
			$counter ++;
		}
	}
	...
	public function render( $factory ) {
		...
		$sortable_class = 'mkd-sortable-holder';
		...
		<div class="mkd-repeater-wrapper">
			<div class="mkd-repeater-fields-holder <?php echo esc_attr( $sortable_class ); ?> clearfix">
			...
			<div class="mkd-repeater-add">
				<a class="mkd-clone btn btn-sm btn-primary" data-count="<?php echo esc_attr( $this->num_of_rows ) ?>" href="#"><?php echo esc_html( $this->button_text ); ?></a>
			</div>
		</div>
		<?php
	}
...
class EntreMikadoTableRepeater implements iEntreMikadoRender {
	private $label;
	private $description;
	private $name;
	private $fields;
	...
	function __construct( $fields, $name, $label = '', $description = '', $button_text = '' ) {
		...
		$this->name        = $name;
		$this->num_of_rows = 1;
		$this->button_text = ! empty( $button_text ) ? $button_text : esc_html__( 'Add New', 'entre' );
	...
	public function render( $factory ) {
		...
		<div class="mkd-repeater-wrapper mkd-question-answers">
			<table class="mkd-repeater-fields-holder mkd-table-layout <?php echo esc_attr( $sortable_class ); ?> clearfix">
				<thead>
				<tr>
					<th><?php esc_html_e( 'Order', 'entre' ) ?></th>
					<?php foreach ( $this->fields as $field ) { ?>
						<th><?php echo esc_html( $field['th'] ); ?></th>
					<?php } ?>
					<th><?php esc_html_e( 'Remove', 'entre' ) ?></th>
				</tr>
				</thead>
...
class EntreMikadoRowRepeater implements iEntreMikadoRender {
	private $label;
	private $description;
	private $name;
	private $fields;
	...
	public function render( $factory ) {
		...
		?>
		<div class="mkd-repeater-wrapper mkd-repeater-row-type">
			<div class="mkd-repeater-fields-holder <?php echo esc_attr( $sortable_class ); ?> clearfix">
				<?php if ( empty( $clones ) ) { //first time
					$counter = 0; ?>
					<div class="mkd-repeater-fields-row mkd-initially-hidden">
						<div class="mkd-repeater-fields-row-inner">
							...
							<div class="mkd-repeater-rows-holder">
								<div class="row">
									<?php foreach ( $this->fields as $field ) { ?>
...
class EntreMikadoParentChildRepeater implements iEntreMikadoRender {
	private $num_of_rows;
	private $name;
	private $label;
	private $description;
	...
	public function render( $factory ) {
		...
		<div class="mkd-repeater-wrapper">
			<div class="mkd-repeater-fields-holder mkd-enable-pc mkd-sortable-holder clearfix" data-fields-number="<?php echo esc_attr( sizeof( $this->fields ) ) ?>">
				<?php if ( empty( $clones ) ) {
					...
					foreach ( $this->not_used_fields as $field ) {
						...
						?>
						<div class="mkd-repeater-fields-row <?php echo esc_attr( $sorting_class ); ?> mkd-initially-hidden"
			...
			<?php foreach ( $this->fields as $field ) { ?>
				<div class="mkd-repeater-add">
					<a class="mkd-clone btn btn-sm btn-primary" data-count="<?php echo esc_attr( $this->num_of_rows ) ?>" data-name="<?php echo esc_attr( $field['name'] ) ?>" href="#"><?php echo esc_html( $field['button_text'] ); ?></a>
				</div>
			<?php } ?>
		</div>
		<?php
...
class EntreMikadoFieldAddress extends EntreMikadoFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $hidden = false, $repeat = array() ) {
		...
		<div class="mkd-page-form-section mkd-address-field <?php echo esc_attr( $class ); ?>" data-country="<?php echo esc_attr( $country ); ?>" data-lat-field="<?php echo esc_attr( $lat_field ); ?>" data-long-field="<?php echo esc_attr( $long_field ); ?>" id="mkd_<?php echo esc_attr( $id ); ?>"<?php if ( $hidden ) { ?> style="display: none"<?php } ?>>
			<div class="mkd-field-desc">
				...
				<div class="container-fluid">
					<div class="row">
						...
						<?php endif; ?>
							...
							<button id="find" class="btn btn-primary"><?php esc_html_e( 'Place the pin on the map', 'entre' ); ?></button>
							<a id="reset" href="#" style="display:none;"><?php esc_html_e( 'Reset Marker', 'entre' ); ?></a>
						</div>
					</div>
				</div>
			</div>
...
class EntreMikadoFieldIcon extends EntreMikadoFieldType {
    public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $hidden = false ) {
        ...
        $icon_packs        = \EntreMikadoIconCollections::get_instance()->getIconCollectionsEmpty();
        $icons_collections = \EntreMikadoIconCollections::get_instance()->getIconCollectionsKeys();
        ...
        <div class="mkd-page-form-section <?php echo esc_attr($class); ?>" id="mkd_<?php echo esc_attr($id); ?>" <?php if ($hidden) { ?> style="display: none"<?php } ?>>
            ...
            <div class="mkd-section-content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-<?php echo esc_attr($col_width); ?>">
                            <select name="<?php echo esc_attr( $name ) . '[icon_pack]'; ?>" class="<?php echo esc_attr($select2) ?> form-control mkd-form-element dependence icon-dependence">
                    ...
                    <?php foreach ( $icons_collections as $icons_collection ) { ?>
                        <?php
                        $icons_param = \EntreMikadoIconCollections::get_instance()->getIconCollectionParamNameByKey( $icons_collection );
                        $style       = 'display: none';
                        if ( !empty($rvalue) && $rvalue['icon_pack'] == $icons_collection ) {
                            $style = 'display: block';
                        }
                        ?>
                        <div class="row mkd-icon-collection-holder" style="<?php echo esc_attr( $style ); ?>" data-icon-collection="<?php echo esc_attr( $icons_collection ); ?>">
                            <div class="col-lg-<?php echo esc_attr($col_width); ?>">
                                <select name="<?php echo esc_attr( $name . '[' . $icons_param . ']'); ?>" class="<?php echo esc_attr($select2) ?> form-control mkd-form-element">
                                    <?php
                                    $icons      = \EntreMikadoIconCollections::get_instance()->getIconCollection( $icons_collection );
