...
if ( ! function_exists('entre_mikado_breadcrumbs_title_type_options_map') ) {
	function entre_mikado_breadcrumbs_title_type_options_map($panel_typography) {
		
		entre_mikado_add_admin_section_title(
			array(
				'name'   => 'type_section_breadcrumbs',
				'title'  => esc_html__( 'Breadcrumbs', 'entre' ),
				'parent' => $panel_typography
			)
		);
	
		$group_page_breadcrumbs_styles = entre_mikado_add_admin_group(
			array(
				'name'        => 'group_page_breadcrumbs_styles',
				'title'       => esc_html__( 'Breadcrumbs', 'entre' ),
				'description' => esc_html__( 'Define styles for page breadcrumbs', 'entre' ),
				'parent'      => $panel_typography
			)
		);
	
			$row_page_breadcrumbs_styles_1 = entre_mikado_add_admin_row(
				array(
			...
			$row_page_breadcrumbs_styles_2 = entre_mikado_add_admin_row(
				array(
			...
			$row_page_breadcrumbs_styles_3 = entre_mikado_add_admin_row(
				array(
				...
				entre_mikado_add_admin_field(
					array(
						...
						'default_value' => '',
						'label'         => esc_html__( 'Hover/Active Text Color', 'entre' ),
						'parent'        => $row_page_breadcrumbs_styles_3
					)
				);
    }

	add_action( 'entre_mikado_additional_title_typography_options_map', 'entre_mikado_breadcrumbs_title_type_options_map');
}