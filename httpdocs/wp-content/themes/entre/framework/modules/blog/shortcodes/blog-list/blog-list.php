...
class BlogList implements Lib\ShortcodeInterface {
	...
	function __construct() {
		...
		//Category filter
		add_filter( 'vc_autocomplete_mkd_blog_list_category_callback', array( &$this, 'blogCategoryAutocompleteSuggester', ), 10, 1 ); // Get suggestion(find). Must return an array
		
		//Category render
		add_filter( 'vc_autocomplete_mkd_blog_list_category_render', array( &$this, 'blogCategoryAutocompleteRender', ), 10, 1 ); // Get suggestion(find). Must return an array
	}
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Mikado Blog List', 'entre' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Excerpt', 'entre' ),
					...
					array(
						...
						'heading'     => esc_html__( 'Text Length', 'entre' ),
						'description' => esc_html__( 'Number of characters. Use this option only if you set excerpt to YES', 'entre' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Image', 'entre' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Section', 'entre' ),
						'value'      => array_flip( entre_mikado_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'type', 'value'   => array( 'standard', 'boxed', 'masonry' ) ),
						'group'      => esc_html__( 'Post Info', 'entre' )
					),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Like', 'entre' ),
						'value'      => array_flip( entre_mikado_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'entre' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Share', 'entre' ),
						'value'      => array_flip( entre_mikado_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'entre' )
					),
					array(
						...
						'heading'    => esc_html__( 'Pagination Type', 'entre' ),
						'value'      => array(
							esc_html__( 'None', 'entre' )            => 'no-pagination',
							esc_html__( 'Standard', 'entre' )        => 'standard-shortcodes',
							esc_html__( 'Load More', 'entre' )       => 'load-more',
							esc_html__( 'Infinite Scroll', 'entre' ) => 'infinite-scroll'
						),
						'group'      => esc_html__( 'Additional Features', 'entre' )
					)
				)
			)
		);
	...
	public function render( $atts, $content = null ) {
		...
		entre_mikado_get_module_template_part( 'shortcodes/blog-list/holder', 'blog', $params['type'], $params );
	...
	public function getHolderClasses( $params, $default_atts ) {
		...
		$holderClasses[] = ! empty( $params['type'] ) ? 'mkd-bl-' . $params['type'] : 'mkd-bl-' . $default_atts['type'];
		...
		$holderClasses[] = ! empty( $params['pagination_type'] ) ? 'mkd-bl-pag-' . $params['pagination_type'] : 'mkd-bl-pag-' . $default_atts['pagination_type'];
	...
	public function getColumnNumberClass( $params ) {
		switch ( $params ) {
			case 1:
				$classes = 'mkd-bl-one-column';
				break;
			case 2:
				$classes = 'mkd-bl-two-columns';
				break;
			case 3:
				$classes = 'mkd-bl-three-columns';
				break;
			case 4:
				$classes = 'mkd-bl-four-columns';
				break;
			case 5:
				$classes = 'mkd-bl-five-columns';
				break;
			default:
				$classes = 'mkd-bl-three-columns';
				break;
