...
<div class="mkd-blog-video-holder">
    ...
    if ( $video_type == 'social_networks' ) {
	    ...
	    $videolink  = get_post_meta(get_the_ID(), "mkd_post_video_custom_meta", true);
	    $videoimage = get_post_meta(get_the_ID(), "mkd_post_video_image_meta", true);
	    ...
	    <div class="mkd-self-hosted-video-holder">
		    <div class="mkd-video-wrap">
			    <video class="mkd-self-hosted-video" poster="<?php echo esc_url( $videoimage ); ?>" preload="auto">
				    ...
				    <object width="320" height="240" type="application/x-shockwave-flash" data="<?php echo esc_url( $flashmedia ); ?>">
					    ...
					    <img itemprop="image" src="<?php echo esc_url( $videoimage ); ?>" width="1920" height="800" title="<?php esc_attr_e( 'No video playback capabilities', 'entre' ); ?>" alt="<?php esc_attr_e( 'Video Thumb', 'entre' ); ?>"/>
				    </object>
			    </video>
		    </div>
	    </div>
