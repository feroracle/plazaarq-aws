...
if( !function_exists('entre_mikado_get_blog_single_holder_classes') ) {
    /**
     * Function that generates blog holder classes for single blog page
     */
    function entre_mikado_get_blog_single_holder_classes($classes) {
    ...
    add_filter( 'entre_mikado_blog_single_holder_classes', 'entre_mikado_get_blog_single_holder_classes' );
}
