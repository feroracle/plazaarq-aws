<?php
$show_related = entre_mikado_options()->getOptionValue('blog_single_related_posts') == 'yes' ? true : false;
$related_post_number = entre_mikado_sidebar_layout() === 'no-sidebar' ? 4 : 3;
$related_posts_options = array(
    'posts_per_page' => $related_post_number
);
$related_posts = entre_mikado_get_blog_related_post_type(get_the_ID(), $related_posts_options);
        ...
        <div class="mkd-related-posts-holder-inner">
            <?php if ( $related_posts && $related_posts->have_posts() ) : ?>
                <div class="mkd-related-posts-title">
                    <h4><?php esc_html_e('RELATED POSTS', 'entre' ); ?></h4>
                </div>
                        ...
                        <div class="mkd-related-post">
                            <div class="mkd-related-post-inner">
                                ...
                                <div class="mkd-post-info">
                                    ...
                                    <?php entre_mikado_get_module_template_part('templates/parts/post-info/author', 'blog', '', $params); ?>
                                </div>
                            </div>
                        </div>
                    <?php endwhile; ?>
