...
if ( ! function_exists( 'entre_mikado_get_hide_dep_for_header_menu_area_meta_boxes' ) ) {
	function entre_mikado_get_hide_dep_for_header_menu_area_meta_boxes() {
		$hide_dep_options = apply_filters( 'entre_mikado_header_menu_area_hide_meta_boxes', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'entre_mikado_header_menu_area_meta_options_map' ) ) {
	function entre_mikado_header_menu_area_meta_options_map( $header_meta_box ) {
		$hide_dep_options = entre_mikado_get_hide_dep_for_header_menu_area_meta_boxes();
		...
		entre_mikado_create_meta_box_field(
			array(
				...
				'type'          => 'yesno',
				'default_value' => 'no',
				'label'         => esc_html__( 'Disable Header Menu Area Widget', 'entre' ),
				'description'   => esc_html__( 'Enabling this option will hide widget area from the menu area', 'entre' ),
				'parent'        => $menu_area_container
			)
		);
		...
		if ( is_array( $entre_custom_sidebars ) && count( $entre_custom_sidebars ) > 0 ) {
			entre_mikado_create_meta_box_field(
				array(
					...
					'type'        => 'selectblank',
					'label'       => esc_html__( 'Choose Custom Widget Area In Menu Area', 'entre' ),
					'description' => esc_html__( 'Choose custom widget area to display in header menu area"', 'entre' ),
					'parent'      => $menu_area_container,
		...
		entre_mikado_create_meta_box_field(
			array(
				...
				'description' => esc_html__( 'Set grid background transparency for menu area (0 = fully transparent, 1 = opaque)', 'entre' ),
				'parent'      => $menu_area_in_grid_container,
				'args'        => array(
					'col_width' => 2
				)
		...
		entre_mikado_create_meta_box_field(
			array(
				...
				'description'   => esc_html__( 'Set shadow on grid menu area', 'entre' ),
				'parent'        => $menu_area_in_grid_container,
				'default_value' => '',
				'options'       => entre_mikado_get_yes_no_select_array()
			)
		...
		entre_mikado_create_meta_box_field(
			array(
				...
				'description'   => esc_html__( 'Set border on grid menu area', 'entre' ),
				'parent'        => $menu_area_in_grid_container,
				'default_value' => '',
				'options'       => entre_mikado_get_yes_no_select_array(),
				'args'          => array(
		...
		entre_mikado_create_meta_box_field(
			array(
				...
				'description' => esc_html__( 'Choose a background color for menu area', 'entre' ),
				'parent'      => $menu_area_container
			)
		);
		...
		entre_mikado_create_meta_box_field(
			array(
				...
				'description' => esc_html__( 'Choose a transparency for the menu area background color (0 = fully transparent, 1 = opaque)', 'entre' ),
				'parent'      => $menu_area_container,
				'args'        => array(
					'col_width' => 2
				)
		...
		entre_mikado_create_meta_box_field(
			array(
				...
				'type'          => 'select',
				'label'         => esc_html__( 'Menu Area Shadow', 'entre' ),
		...
		$menu_area_border_bottom_color_container = entre_mikado_add_admin_container(
			array(
				'type'            => 'container',
		...
		entre_mikado_create_meta_box_field(
			array(
				'parent'        => $menu_area_container,
				'type'          => 'text',
				'name'          => 'mkd_dropdown_top_position_meta',
		...
		do_action( 'entre_mikado_header_menu_area_additional_meta_boxes_map', $menu_area_container );
	}
	
	add_action( 'entre_mikado_header_menu_area_meta_boxes_map', 'entre_mikado_header_menu_area_meta_options_map', 10, 1 );
}