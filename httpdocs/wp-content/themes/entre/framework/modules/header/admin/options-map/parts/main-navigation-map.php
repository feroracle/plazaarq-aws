...
if ( ! function_exists( 'entre_mikado_get_hide_dep_for_header_main_menu_options' ) ) {
	function entre_mikado_get_hide_dep_for_header_main_menu_options() {
		$hide_dep_options = apply_filters( 'entre_mikado_header_main_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'entre_mikado_header_main_navigation_options_map' ) ) {
	function entre_mikado_header_main_navigation_options_map() {
		$hide_dep_options = entre_mikado_get_hide_dep_for_header_main_menu_options();
		
		$panel_main_menu = entre_mikado_add_admin_panel(
			array(
				'title'           => esc_html__( 'Main Menu', 'entre' ),
		...
		entre_mikado_add_admin_section_title(
			array(
				...
				'title'  => esc_html__( 'Main Menu General Settings', 'entre' )
			)
		);
		
		$drop_down_group = entre_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'drop_down_group',
				'title'       => esc_html__( 'Main Dropdown Menu', 'entre' ),
				'description' => esc_html__( 'Choose a color and transparency for the main menu background (0 = fully transparent, 1 = opaque)', 'entre' )
			)
		);
		
		$drop_down_row1 = entre_mikado_add_admin_row(
			array(
		...
		entre_mikado_add_admin_field(
			array(
				...
				'label'         => esc_html__( 'Main Dropdown Menu Appearance', 'entre' ),
				'description'   => esc_html__( 'Choose appearance for dropdown menu', 'entre' ),
				'options'       => array(
					'dropdown-default'        => esc_html__( 'Default', 'entre' ),
					'dropdown-animate-height' => esc_html__( 'Animate Height', 'entre' )
				)
			)
		);
		...
		entre_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dropdown Position', 'entre' ),
				'description'   => esc_html__( 'Enter value in percentage of entire header height', 'entre' ),
				'args'          => array(
					'col_width' => 3,
					'suffix'    => '%'
				)
		...
		$first_level_group = entre_mikado_add_admin_group(
			array(
				...
				'title'       => esc_html__( '1st Level Menu', 'entre' ),
				'description' => esc_html__( 'Define styles for 1st level in Top Navigation Menu', 'entre' )
			)
		);
		...
		entre_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Active Text Color', 'entre' ),
			)
		);
		
		$first_level_row3 = entre_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		entre_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Hover Text Color', 'entre' ),
			)
		);
		...
		entre_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Active Text Color', 'entre' ),
			)
		);
		
		$first_level_row4 = entre_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		entre_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Hover Text Color', 'entre' ),
			)
		);
		...
		entre_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Active Text Color', 'entre' ),
			)
		);
		
		$first_level_row5 = entre_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row6 = entre_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row7 = entre_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		entre_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left/Right', 'entre' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		entre_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Left/Right', 'entre' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$second_level_group = entre_mikado_add_admin_group(
			array(
				...
				'title'       => esc_html__( '2nd Level Menu', 'entre' ),
				'description' => esc_html__( 'Define styles for 2nd level in Top Navigation Menu', 'entre' )
			)
		);
		...
		entre_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hover/Active Color', 'entre' )
			)
		);
		...
		$second_level_row3 = entre_mikado_add_admin_row(
			array(
				'parent' => $second_level_group,
		...
		$second_level_wide_group = entre_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'second_level_wide_group',
				'title'       => esc_html__( '2nd Level Wide Menu', 'entre' ),
				'description' => esc_html__( 'Define styles for 2nd level in Wide Menu', 'entre' )
			)
		);
		
		$second_level_wide_row1 = entre_mikado_add_admin_row(
			array(
		...
		$second_level_wide_row2 = entre_mikado_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$second_level_wide_row3 = entre_mikado_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$third_level_group = entre_mikado_add_admin_group(
			array(
				...
				'title'       => esc_html__( '3nd Level Menu', 'entre' ),
				'description' => esc_html__( 'Define styles for 3nd level in Top Navigation Menu', 'entre' )
			)
		);
		...
		$third_level_row3 = entre_mikado_add_admin_row(
			array(
				'parent' => $third_level_group,
		...
		$third_level_wide_group = entre_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_wide_group',
				'title'       => esc_html__( '3rd Level Wide Menu', 'entre' ),
				'description' => esc_html__( 'Define styles for 3rd level in Wide Menu', 'entre' )
			)
		);
		
		$third_level_wide_row1 = entre_mikado_add_admin_row(
			array(
		...
		$third_level_wide_row2 = entre_mikado_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
		...
		$third_level_wide_row3 = entre_mikado_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
	...
	add_action( 'entre_mikado_header_main_navigation_options_map', 'entre_mikado_header_main_navigation_options_map', 10, 1 );
}