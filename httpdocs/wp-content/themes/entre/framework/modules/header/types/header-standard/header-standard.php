...
class HeaderStandard extends HeaderType {
	...
	public function loadTemplate( $parameters = array() ) {
		...
		$parameters['menu_area_position_class'] = ! empty( $menu_area_position ) ? 'mkd-menu-' . $menu_area_position : 'mkd-menu-right';
		
		$parameters = apply_filters( 'entre_mikado_header_standard_parameters', $parameters );
