...
if (!class_exists('EntreMikadoFullscreenNavigationWalker')) {
	class EntreMikadoFullscreenNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($item->hide == ""){
				...
				if($args->has_children) {
					$item_output .= '<span class="mkd-fullscreen-menu-arrow"></span>';
				}
				$item_output .= '</a>';
			}
