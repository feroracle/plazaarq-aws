...
if ( ! function_exists( 'entre_mikado_vertical_menu_styles' ) ) {
	function entre_mikado_vertical_menu_styles() {
	...
	add_action( 'entre_mikado_style_dynamic', 'entre_mikado_vertical_menu_styles' );
}

if ( ! function_exists( 'entre_mikado_vertical_main_menu_styles' ) ) {
	/**
	 * Generates styles for vertical main main menu
	 */
	function entre_mikado_vertical_main_menu_styles() {
		...
		if ( ! empty( $menu_top_margin ) ) {
			$menu_holder_styles['margin-top'] = entre_mikado_filter_px( $menu_top_margin ) . 'px';
		}
		if ( ! empty( $menu_bottom_margin ) ) {
			$menu_holder_styles['margin-bottom'] = entre_mikado_filter_px( $menu_bottom_margin ) . 'px';
		}
		...
		echo entre_mikado_dynamic_css( $menu_holder_selector, $menu_holder_styles );
	...
	add_action( 'entre_mikado_style_dynamic', 'entre_mikado_vertical_main_menu_styles' );
}