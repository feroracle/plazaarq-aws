...
if ( ! function_exists( 'entre_mikado_get_hide_dep_for_header_vertical_menu_options' ) ) {
	function entre_mikado_get_hide_dep_for_header_vertical_menu_options() {
		$hide_dep_options = apply_filters( 'entre_mikado_header_vertical_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'entre_mikado_header_vertical_navigation_options_map' ) ) {
	function entre_mikado_header_vertical_navigation_options_map() {
		$hide_dep_options = entre_mikado_get_hide_dep_for_header_vertical_menu_options();
		
		$panel_vertical_main_menu = entre_mikado_add_admin_panel(
			array(
				'title'           => esc_html__( 'Vertical Main Menu', 'entre' ),
		...
		$drop_down_group = entre_mikado_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Set a style for dropdown menu', 'entre' )
			)
		);
		
		$vertical_drop_down_row1 = entre_mikado_add_admin_row(
			array(
		...
		entre_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Top Margin', 'entre' ),
				'args'          => array(
					'suffix' => 'px'
				),
		...
		entre_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Bottom Margin', 'entre' ),
				'args'          => array(
					'suffix' => 'px'
				),
				'parent'        => $vertical_drop_down_row1
		...
		$group_vertical_first_level = entre_mikado_add_admin_group(
			array(
				'name'        => 'group_vertical_first_level',
				'title'       => esc_html__( '1st level', 'entre' ),
				'description' => esc_html__( 'Define styles for 1st level menu', 'entre' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_first_level_1 = entre_mikado_add_admin_row(
			array(
		...
		$row_vertical_first_level_2 = entre_mikado_add_admin_row(
			array(
		...
		$row_vertical_first_level_3 = entre_mikado_add_admin_row(
			array(
		...
		$group_vertical_second_level = entre_mikado_add_admin_group(
			array(
				'name'        => 'group_vertical_second_level',
				'title'       => esc_html__( '2nd level', 'entre' ),
				'description' => esc_html__( 'Define styles for 2nd level menu', 'entre' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_second_level_1 = entre_mikado_add_admin_row(
			array(
		...
		$row_vertical_second_level_2 = entre_mikado_add_admin_row(
			array(
		...
		$row_vertical_second_level_3 = entre_mikado_add_admin_row(
			array(
		...
		$group_vertical_third_level = entre_mikado_add_admin_group(
			array(
				'name'        => 'group_vertical_third_level',
				'title'       => esc_html__( '3rd level', 'entre' ),
				'description' => esc_html__( 'Define styles for 3rd level menu', 'entre' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_third_level_1 = entre_mikado_add_admin_row(
			array(
		...
		$row_vertical_third_level_2 = entre_mikado_add_admin_row(
			array(
		...
		$row_vertical_third_level_3 = entre_mikado_add_admin_row(
			array(
	...
	add_action( 'entre_mikado_additional_header_main_navigation_options_map', 'entre_mikado_header_vertical_navigation_options_map', 10, 1 );
}