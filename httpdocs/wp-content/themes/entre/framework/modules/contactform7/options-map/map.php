...
if ( ! function_exists('entre_mikado_contact_form_7_options_map') ) {

	function entre_mikado_contact_form_7_options_map() {

		entre_mikado_add_admin_page(array(
			'slug'	=> '_contact_form7_page',
			'title'	=> esc_html__('Contact Form 7', 'entre'),
			'icon'	=> 'fa fa-envelope-o'
		));

		$panel_contact_form_style_1 = entre_mikado_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_1',
			'title'	=> esc_html__('Custom Style 1', 'entre')
		));

		//Text Typography

		$typography_text_group = entre_mikado_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'entre'),
			'description'	=> esc_html__('Setup typography for form elements text', 'entre'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_text_row1 = entre_mikado_add_admin_row(array(
		...
		entre_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Text Color', 'entre'),
		));
		...
		$typography_text_row2 = entre_mikado_add_admin_row(array(
		...
		$typography_text_row3 = entre_mikado_add_admin_row(array(
		...
		$typography_label_group = entre_mikado_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'entre'),
			'description'	=> esc_html__('Setup typography for form elements label', 'entre'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_label_row1 = entre_mikado_add_admin_row(array(
		...
		$typography_label_row2 = entre_mikado_add_admin_row(array(
		...
		$background_border_group = entre_mikado_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'entre'),
			'description'	=> esc_html__('Setup form elements background and border style', 'entre'),
			'parent'		=> $panel_contact_form_style_1
		));

		$background_border_row1 = entre_mikado_add_admin_row(array(
		...
		entre_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Color', 'entre')
		));
		...
		entre_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Transparency', 'entre')
		));

		$background_border_row2 = entre_mikado_add_admin_row(array(
		...
		entre_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Transparency', 'entre'),
		));
		...
		entre_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Color', 'entre')
		));
		...
		entre_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Transparency', 'entre')
		));

		$background_border_row3 = entre_mikado_add_admin_row(array(
		...
		entre_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Width', 'entre'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		entre_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Radius', 'entre'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$padding_group = entre_mikado_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'entre'),
			'description'	=> 'Setup form elements padding',
			'parent'		=> $panel_contact_form_style_1
		));

		$padding_row = entre_mikado_add_admin_row(array(
			'name'		=> 'padding_row',
		...
		entre_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Top', 'entre'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		entre_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Right', 'entre'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		entre_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Bottom', 'entre'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		entre_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Left', 'entre'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$margin_group = entre_mikado_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'entre'),
			'description'	=> esc_html__('Setup form elements margin', 'entre'),
			'parent'		=> $panel_contact_form_style_1
		));

		$margin_row = entre_mikado_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		entre_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Textarea Height', 'entre'),
			'description'	=> esc_html__('Enter height for textarea form element', 'entre'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$button_typography_group = entre_mikado_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'entre'),
			'description'	=> esc_html__('Setup button text typography', 'entre'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_typography_row1 = entre_mikado_add_admin_row(array(
		...
		entre_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Hover Text Color', 'entre')
		));
		...
		$button_typography_row2 = entre_mikado_add_admin_row(array(
		...
		$button_background_border_group = entre_mikado_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'entre'),
			'description'	=> esc_html__('Setup button background and border style', 'entre'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_background_border_row1 = entre_mikado_add_admin_row(array(
		...
		entre_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Color', 'entre')
		));
		...
		entre_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Transparency', 'entre')
		));

		$button_background_border_row2 = entre_mikado_add_admin_row(array(
		...
		entre_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Color', 'entre')
		));
		...
		entre_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Transparency', 'entre')
		));

		$button_background_border_row3 = entre_mikado_add_admin_row(array(
		...
		entre_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Height', 'entre'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		entre_mikado_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Left/Right Padding', 'entre'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$panel_contact_form_style_2 = entre_mikado_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'entre')
		));
        ...
        $panel_contact_form_style_3 = entre_mikado_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'entre')
        ));
        ...
        $typography_label_row3 = entre_mikado_add_admin_row(array(
        ...
        $button_typography_row3 = entre_mikado_add_admin_row(array(
	...
	add_action( 'entre_mikado_options_map', 'entre_mikado_contact_form_7_options_map', 20);
}