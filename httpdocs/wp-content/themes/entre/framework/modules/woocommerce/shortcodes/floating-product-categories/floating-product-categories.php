<?php
namespace MikadoCore\CPT\Shortcodes\FloatingProductCategories;
...
class FloatingProductCategories implements Lib\ShortcodeInterface {
	...
	function __construct() {
		$this->base = 'mkd_floating_product_categories';
		
		add_action('vc_before_init', array($this,'vcMap'));

		//Portfolio category filter
		add_filter( 'vc_autocomplete_mkd_floating_product_categories_category_callback', array( &$this, 'productCategoryAutocompleteSuggester', ), 10, 1 ); // Get suggestion(find). Must return an array

		//Portfolio category render
		add_filter( 'vc_autocomplete_mkd_floating_product_categories_category_render', array( &$this, 'productCategoryAutocompleteRender', ), 10, 1 ); // Get suggestion(find). Must return an array
	}
	...
	public function vcMap() {
		vc_map( array(
			'name' => esc_html__('Mikado Floating Product Categories', 'entre'),
			'base' => $this->base,
	...
	public function render($atts, $content = null) {
		...
		$html = entre_mikado_get_woo_shortcode_module_template_part('templates/holder', 'floating-product-categories', '', $params);
	...
	*/
	...
	public function generateImgPositionClass($position){
		...
		$position_class = 'mkd-img-'.esc_attr($position).'-side';
	...
	public function generateContentPositionClass($position){
		...
		$position_class = 'mkd-content-'.esc_attr($position);
		return $position_class;
	...
	public function generateImgSizeClass($size){
		...
		$size_class = 'mkd-img-'.esc_attr($size).'-size';
		return $size_class;
