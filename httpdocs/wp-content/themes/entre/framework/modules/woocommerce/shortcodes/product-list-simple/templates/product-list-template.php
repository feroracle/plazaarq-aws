    ...
    <ul class="mkd-pls-inner">
            ...
            <li class="mkd-pls-item">
                <div class="mkd-pls-image">
                    <a itemprop="url" href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>">
                        <?php entre_mikado_get_module_template_part('templates/parts/image-simple', 'woocommerce', '', $params); ?>
                    </a>    
                </div>
        ...
        <?php endwhile; else: ?>
            <li class="mkd-pls-messsage">
                <?php entre_mikado_get_module_template_part('templates/parts/no-posts', 'woocommerce', '', $params); ?>
            </li>
        <?php endif;
            wp_reset_postdata();
        ?>
