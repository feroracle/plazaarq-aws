...
class ProductListSimple implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Mikado Product List - Simple', 'entre' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						array(
							...
							'value'      => array(
								esc_html__( 'Sale', 'entre' )         => 'sale',
								esc_html__( 'Best Sellers', 'entre' ) => 'best-sellers',
								esc_html__( 'Featured', 'entre' )     => 'featured'
							),
							'save_always' => true
						),
						array(
							...
							'description' => esc_html__( 'Number of products to show (default value is 4)', 'entre' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'orderby',
	...
	public function render( $atts, $content = null ) {
		...
		$html = entre_mikado_get_woo_shortcode_module_template_part( 'templates/product-list-template', 'product-list-simple', '', $params );
