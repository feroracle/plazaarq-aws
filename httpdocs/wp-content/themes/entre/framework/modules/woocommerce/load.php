...
if ( entre_mikado_is_woocommerce_installed() ) {
	...
	include_once MIKADO_FRAMEWORK_MODULES_ROOT_DIR. '/woocommerce/admin/taxonomies-map/taxonomies.php';
	include_once MIKADO_FRAMEWORK_MODULES_ROOT_DIR. '/woocommerce/admin/taxonomies-map/field-creator.php';
