...
if ( class_exists( 'EntreCoreClassWidget' ) ) {
	...
	class EntreMikadoSocialIconWidget extends EntreCoreClassWidget {
		
		public function __construct() {
			parent::__construct(
				'mkd_social_icon_widget',
				esc_html__( 'Mikado Social Icon Widget', 'entre' ),
				array( 'description' => esc_html__( 'Add social network icons to widget areas', 'entre' ) )
			);
		...
		protected function setParams() {
			$this->params = array_merge(
				entre_mikado_icon_collections()->getSocialIconWidgetParamsArray(),
				array(
					array(
						'type'  => 'textfield',
						'name'  => 'link',
		...
		public function widget( $args, $instance ) {
			...
			<a class="mkd-social-icon-widget-holder mkd-icon-has-hover" <?php echo entre_mikado_get_inline_attr( $hover_color, 'data-hover-color' ); ?> <?php entre_mikado_inline_style( $icon_styles ) ?>
