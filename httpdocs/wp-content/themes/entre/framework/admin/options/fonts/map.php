...
if ( ! function_exists( 'entre_mikado_fonts_options_map' ) ) {
	/**
	 * Font options page
	 */
	function entre_mikado_fonts_options_map() {
		
		entre_mikado_add_admin_page(
			array(
				'slug'  => '_fonts_page',
				'title' => esc_html__( 'Fonts', 'entre' ),
				'icon'  => 'fa fa-font'
			)
		);
		 ...
		 * Headings
		 */
		$panel_headings = entre_mikado_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_headings',
				'title' => esc_html__( 'Headings', 'entre' )
			)
		);
		
		//H1
		$group_heading_h1 = entre_mikado_add_admin_group(
			array(
				'name'        => 'group_heading_h1',
				'title'       => esc_html__( 'H1 Style', 'entre' ),
				'description' => esc_html__( 'Define styles for h1 heading', 'entre' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h1_1 = entre_mikado_add_admin_row(
			array(
		...
		$row_heading_h1_2 = entre_mikado_add_admin_row(
			array(
		...
		$row_heading_h1_3 = entre_mikado_add_admin_row(
			array(
		...
		entre_mikado_add_admin_field(
			array(
				...
				'name'          => 'h1_margin_top',
				'default_value' => '',
				'label'         => esc_html__( 'Margin Top', 'entre' ),
		...
		entre_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Bottom', 'entre' ),
				'parent'        => $row_heading_h1_3
			)
		);
		
		//H2
		$group_heading_h2 = entre_mikado_add_admin_group(
			array(
				'name'        => 'group_heading_h2',
				'title'       => esc_html__( 'H2 Style', 'entre' ),
				'description' => esc_html__( 'Define styles for h2 heading', 'entre' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h2_1 = entre_mikado_add_admin_row(
			array(
		...
		$row_heading_h2_2 = entre_mikado_add_admin_row(
			array(
		...
		$row_heading_h2_3 = entre_mikado_add_admin_row(
			array(
		...
		//H3
		$group_heading_h3 = entre_mikado_add_admin_group(
			array(
				'name'        => 'group_heading_h3',
				'title'       => esc_html__( 'H3 Style', 'entre' ),
				'description' => esc_html__( 'Define styles for h3 heading', 'entre' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h3_1 = entre_mikado_add_admin_row(
			array(
		...
		$row_heading_h3_2 = entre_mikado_add_admin_row(
			array(
		...
		$row_heading_h3_3 = entre_mikado_add_admin_row(
			array(
		...
		//H4
		$group_heading_h4 = entre_mikado_add_admin_group(
			array(
				'name'        => 'group_heading_h4',
				'title'       => esc_html__( 'H4 Style', 'entre' ),
				'description' => esc_html__( 'Define styles for h4 heading', 'entre' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h4_1 = entre_mikado_add_admin_row(
			array(
		...
		$row_heading_h4_2 = entre_mikado_add_admin_row(
			array(
		...
		$row_heading_h4_3 = entre_mikado_add_admin_row(
			array(
		...
		//H5
		$group_heading_h5 = entre_mikado_add_admin_group(
			array(
				'name'        => 'group_heading_h5',
				'title'       => esc_html__( 'H5 Style', 'entre' ),
				'description' => esc_html__( 'Define styles for h5 heading', 'entre' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h5_1 = entre_mikado_add_admin_row(
			array(
		...
		$row_heading_h5_2 = entre_mikado_add_admin_row(
			array(
		...
		$row_heading_h5_3 = entre_mikado_add_admin_row(
			array(
		...
		//H6
		$group_heading_h6 = entre_mikado_add_admin_group(
			array(
				'name'        => 'group_heading_h6',
				'title'       => esc_html__( 'H6 Style', 'entre' ),
				'description' => esc_html__( 'Define styles for h6 heading', 'entre' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h6_1 = entre_mikado_add_admin_row(
			array(
		...
		$row_heading_h6_2 = entre_mikado_add_admin_row(
			array(
		...
		$row_heading_h6_3 = entre_mikado_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings3 = entre_mikado_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings3',
				'title' => esc_html__( 'Headings Responsive (Tablet Landscape View)', 'entre' )
			)
		);
		
		//H1
		$group_responsive3_heading_h1 = entre_mikado_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h1',
				'title'       => esc_html__( 'H1 Responsive Style', 'entre' ),
				'description' => esc_html__( 'Define responsive styles for h1 heading', 'entre' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h1_3 = entre_mikado_add_admin_row(
			array(
		...
		//H2
		$group_responsive3_heading_h2 = entre_mikado_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h2',
				'title'       => esc_html__( 'H2 Responsive Style', 'entre' ),
				'description' => esc_html__( 'Define responsive styles for h2 heading', 'entre' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h2_3 = entre_mikado_add_admin_row(
			array(
		...
		//H3
		$group_responsive3_heading_h3 = entre_mikado_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h3',
				'title'       => esc_html__( 'H3 Responsive Style', 'entre' ),
				'description' => esc_html__( 'Define responsive styles for h3 heading', 'entre' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h3_3 = entre_mikado_add_admin_row(
			array(
		...
		//H4
		$group_responsive3_heading_h4 = entre_mikado_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h4',
				'title'       => esc_html__( 'H4 Responsive Style', 'entre' ),
				'description' => esc_html__( 'Define responsive styles for h4 heading', 'entre' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h4_3 = entre_mikado_add_admin_row(
			array(
		...
		//H5
		$group_responsive3_heading_h5 = entre_mikado_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h5',
				'title'       => esc_html__( 'H5 Responsive Style', 'entre' ),
				'description' => esc_html__( 'Define responsive styles for h5 heading', 'entre' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h5_3 = entre_mikado_add_admin_row(
			array(
		...
		//H6
		$group_responsive3_heading_h6 = entre_mikado_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h6',
				'title'       => esc_html__( 'H6 Responsive Style', 'entre' ),
				'description' => esc_html__( 'Define responsive styles for h6 heading', 'entre' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h6_3 = entre_mikado_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings = entre_mikado_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings',
				'title' => esc_html__( 'Headings Responsive (Tablet Portrait View)', 'entre' )
			)
		);
		
		//H1
		$group_responsive_heading_h1 = entre_mikado_add_admin_group(
			array(
		...
		$row_responsive_heading_h1_1 = entre_mikado_add_admin_row(
			array(
		...
		//H2
		$group_responsive_heading_h2 = entre_mikado_add_admin_group(
			array(
		...
		$row_responsive_heading_h2_1 = entre_mikado_add_admin_row(
			array(
		...
		//H3
		$group_responsive_heading_h3 = entre_mikado_add_admin_group(
			array(
		...
		$row_responsive_heading_h3_1 = entre_mikado_add_admin_row(
			array(
		...
		//H4
		$group_responsive_heading_h4 = entre_mikado_add_admin_group(
			array(
		...
		$row_responsive_heading_h4_1 = entre_mikado_add_admin_row(
			array(
		...
		//H5
		$group_responsive_heading_h5 = entre_mikado_add_admin_group(
			array(
		...
		$row_responsive_heading_h5_1 = entre_mikado_add_admin_row(
			array(
		...
		//H6
		$group_responsive_heading_h6 = entre_mikado_add_admin_group(
			array(
		...
		$row_responsive_heading_h6_1 = entre_mikado_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings2 = entre_mikado_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings2',
				'title' => esc_html__( 'Headings Responsive (Mobile Devices)', 'entre' )
			)
		);
		
		//H1
		$group_responsive2_heading_h1 = entre_mikado_add_admin_group(
			array(
		...
		$row_responsive2_heading_h1_1 = entre_mikado_add_admin_row(
			array(
		...
		//H2
		$group_responsive2_heading_h2 = entre_mikado_add_admin_group(
			array(
		...
		$row_responsive2_heading_h2_1 = entre_mikado_add_admin_row(
			array(
		...
		//H3
		$group_responsive2_heading_h3 = entre_mikado_add_admin_group(
			array(
		...
		$row_responsive2_heading_h3_1 = entre_mikado_add_admin_row(
			array(
		...
		//H4
		$group_responsive2_heading_h4 = entre_mikado_add_admin_group(
			array(
		...
		$row_responsive2_heading_h4_1 = entre_mikado_add_admin_row(
			array(
		...
		//H5
		$group_responsive2_heading_h5 = entre_mikado_add_admin_group(
			array(
		...
		$row_responsive2_heading_h5_1 = entre_mikado_add_admin_row(
			array(
		...
		//H6
		$group_responsive2_heading_h6 = entre_mikado_add_admin_group(
			array(
		...
		$row_responsive2_heading_h6_1 = entre_mikado_add_admin_row(
			array(
		 ...
		 * Text
		 */
		$panel_text = entre_mikado_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_text',
				'title' => esc_html__( 'Text', 'entre' )
			)
		);
		
		$group_text = entre_mikado_add_admin_group(
			array(
				'name'        => 'group_text',
				'title'       => esc_html__( 'Paragraph', 'entre' ),
				'description' => esc_html__( 'Define styles for paragraph text', 'entre' ),
				'parent'      => $panel_text
			)
		);
		
		$row_text_1 = entre_mikado_add_admin_row(
			array(
				'name'   => 'row_text_1',
				'parent' => $group_text
			)
		...
		$row_text_2 = entre_mikado_add_admin_row(
			array(
				'name'   => 'row_text_2',
				'parent' => $group_text,
				'next'   => true
		...
		$group_text_res1 = entre_mikado_add_admin_group(
			array(
				'name'        => 'group_text_res1',
				'title'       => esc_html__( 'Paragraph Responsive (Table Portrait View)', 'entre' ),
				'description' => esc_html__( 'Define responsive styles for paragraph text for table devices - portrait view', 'entre' ),
				'parent'      => $panel_text
			)
		);
		
		$row_res_text_1 = entre_mikado_add_admin_row(
			array(
				'name'   => 'row_text_1',
		...
		$group_text_res2 = entre_mikado_add_admin_group(
			array(
				'name'        => 'group_text_res2',
				'title'       => esc_html__( 'Paragraph Responsive (Mobile Devices)', 'entre' ),
				'description' => esc_html__( 'Define responsive styles for paragraph text for mobile devices', 'entre' ),
				'parent'      => $panel_text
			)
		);
		
		$row_res_text_2 = entre_mikado_add_admin_row(
			array(
				'name'   => 'row_res_text_2',
		...
		$group_link = entre_mikado_add_admin_group(
			array(
				'name'        => 'group_link',
				'title'       => esc_html__( 'Links', 'entre' ),
				'description' => esc_html__( 'Define styles for link text', 'entre' ),
				'parent'      => $panel_text
			)
		);
		
		$row_link_1 = entre_mikado_add_admin_row(
			array(
				'name'   => 'row_link_1',
				'parent' => $group_link
			)
		...
		entre_mikado_add_admin_field(
			array(
				...
				'name'          => 'link_color',
				'default_value' => '',
				'label'         => esc_html__( 'Link Color', 'entre' ),
				'parent'        => $row_link_1
			)
		);
		...
		entre_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hover Link Color', 'entre' ),
				'parent'        => $row_link_1
			)
		);
		
		$row_link_2 = entre_mikado_add_admin_row(
			array(
				'name'   => 'row_link_2',
				'parent' => $group_link,
				'next'   => true
		...
		entre_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Link Decoration', 'entre' ),
				'options'       => entre_mikado_get_text_decorations(),
				'parent'        => $row_link_2
			)
		);
		...
		entre_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hovel Link Decoration', 'entre' ),
				'options'       => entre_mikado_get_text_decorations(),
				'parent'        => $row_link_2
			)
		);
	...
	add_action( 'entre_mikado_options_map', 'entre_mikado_fonts_options_map', 3 );
}