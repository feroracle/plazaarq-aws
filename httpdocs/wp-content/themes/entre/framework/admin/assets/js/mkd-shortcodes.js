                ...
                },
                {
                    ...
                    onclick: function () {
                        ed.windowManager.open({
                            ...
                            onsubmit: function (e) {
                                ed.insertContent('[mkd_dropcaps type="' + e.data.type + '" color="' + e.data.color + '" background_color="' + e.data.background_color + '"]' + e.data.letter + '[/mkd_dropcaps]');
                            }
                        });
                    }
                },
                {
                    ...
                    onclick: function () {
                        ed.windowManager.open({
                            ...
                            onsubmit: function (e) {
                                ed.insertContent('[mkd_highlight background_color="' + e.data.background_color + '" color="' + e.data.color + '"]' + e.data.text + '[/mkd_highlight]');
                            }
                        });
                    }
                },
                        ...
                        ed.windowManager.open({
                            ...
                            body: [
                                ...
                                },
                                {
                                    ...
                                    label: 'Size',
                                    'values': [
                                        {text: 'Tiny', value: 'mkd-icon-tiny'},
                                        {text: 'Small', value: 'mkd-icon-small'},
                                        {text: 'Medium', value: 'mkd-icon-medium'},
                                        {text: 'Large', value: 'mkd-icon-large'},
                                        {text: 'Very Large', value: 'mkd-icon-huge'}
                                    ]
                                },
                                {
                                    type: 'textbox',
                ...
                },
                {
                    ...
                    onclick: function () {
                        ed.windowManager.open({
                            ...
                            onsubmit: function (e) {
                                ed.insertContent('[mkd_image_tooltip image="' + e.data.image + '" placement="' + e.data.placement + '" color="' + e.data.color + '"]' + e.data.text + '[/mkd_image_tooltip]');
                            }
                        });
                    }
                },
                {
                    ...
                    onclick: function () {
                        ed.windowManager.open({
                            ...
                            onsubmit: function (e) {
                                ed.insertContent('[mkd_separator class_name="' + e.data.class_name + '" type="' + e.data.type + '" position="' + e.data.position + '" color="' + e.data.color + '" border_style="' + e.data.border_style + '" width="' + e.data.width + '" thickness="' + e.data.thickness + '" top_margin="' + e.data.top_margin + '" bottom_margin="' + e.data.bottom_margin + '"]');
                            }
                        });
                    }
                }
