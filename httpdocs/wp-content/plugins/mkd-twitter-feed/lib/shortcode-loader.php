...
class ShortcodeLoader {
    ...
    private function addShortcodes() {
	    $shortcodes_class_name = apply_filters('mkd_twitter_filter_add_vc_shortcode', $shortcodes_class_name = array());
    ...
    public function load() {
    	if(mkd_twitter_theme_installed()) {
		    $this->addShortcodes();
