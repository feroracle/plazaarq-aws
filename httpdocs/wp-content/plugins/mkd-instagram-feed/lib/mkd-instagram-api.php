...
class MikadoInstagramApi {
	...
	const INSTAGRAM_CODE = 'mkd_instagram_code';
	const INSTAGRAM_USER_ID = 'mkd_instagram_user_id';
	const INSTAGRAM_TOKEN = 'mkd_instagram_access_token';
	const INSTAGRAM_TOKEN_LONG_LIVED = 'mkd_instagram_access_token_long_lived';
	const INSTAGRAM_TOKEN_LONG_LIVED_TIME = 'mkd_instagram_access_token_long_lived_time';

	const FACEBOOK_CODE = 'mkd_facebook_code';
	const FACEBOOK_TOKEN = 'mkd_facebook_access_token';

	const CONNECTION_TYPE = 'mkd_connection_type';
	 ...
	 * @return stdClass
	 *
	 * @see MikadoInstagramApi::instagramExchangeCodeForToken()
	 */
