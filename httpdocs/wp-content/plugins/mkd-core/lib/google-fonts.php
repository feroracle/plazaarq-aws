<?php
if ( ! function_exists( 'entre_mikado_init_google_fonts_array' ) ) {
    function entre_mikado_init_google_fonts_array() {
        ...
        $entre_mikado_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'entre_mikado_init_google_fonts_array');
}