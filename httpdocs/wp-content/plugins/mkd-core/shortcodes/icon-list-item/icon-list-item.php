...
class IconListItem implements Lib\ShortcodeInterface {
	...
	public function render( $atts, $content = null ) {
		...
		$args   = array_merge( $args, entre_mikado_icon_collections()->getShortcodeParams() );
	...
	private function getHolderStyles( $params ) {
		...
		if ( $params['item_margin'] !== '' ) {
			$styles[] = 'margin-bottom: ' . entre_mikado_filter_px( $params['item_margin'] ) . 'px';
		}
	...
	private function getIconStyles( $params ) {
		...
		if ( ! empty( $params['icon_size'] ) ) {
			$styles[] = 'font-size: ' . entre_mikado_filter_px( $params['icon_size'] ) . 'px';
		}
	...
	private function getTitleStyles( $params ) {
		...
		if ( ! empty( $params['title_size'] ) ) {
			$styles[] = 'font-size: ' . entre_mikado_filter_px( $params['title_size'] ) . 'px';
		}
		
		if ( $params['title_padding'] !== '' ) {
			$styles[] = 'padding-left: ' . entre_mikado_filter_px( $params['title_padding'] ) . 'px';
		}
