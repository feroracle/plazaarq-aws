...
if ( ! function_exists( 'mkd_core_set_clients_carousel_custom_style_for_vc_shortcodes' ) ) {
	/**
	 * Function that set custom css style for clients carousel shortcode
	 */
	function mkd_core_set_clients_carousel_custom_style_for_vc_shortcodes( $style ) {
		$current_style = '.wpb_content_element.wpb_mkd_clients_carousel_item > .wpb_element_wrapper { 
	...
	add_filter( 'mkd_core_filter_add_vc_shortcodes_custom_style', 'mkd_core_set_clients_carousel_custom_style_for_vc_shortcodes' );
}

if ( ! function_exists( 'mkd_core_set_clients_carousel_icon_class_name_for_vc_shortcodes' ) ) {
	/**
	 ...
	 */
	function mkd_core_set_clients_carousel_icon_class_name_for_vc_shortcodes( $shortcodes_icon_class_array ) {
	...
	add_filter( 'mkd_core_filter_add_vc_shortcodes_custom_icon_class', 'mkd_core_set_clients_carousel_icon_class_name_for_vc_shortcodes' );
}