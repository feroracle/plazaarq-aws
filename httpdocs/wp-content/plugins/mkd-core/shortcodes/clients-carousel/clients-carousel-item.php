...
class ClientsCarouselItem implements Lib\ShortcodeInterface {
	...
	public function __construct() {
		$this->base = 'mkd_clients_carousel_item';
				...
				array(
					...
					'params'                  => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Hover Image', 'mkd-core' ),
							'description' => esc_html__( 'Select image from media library', 'mkd-core' )
						),
						array(
							'type'        => 'textfield',
	...
	public function render( $atts, $content = null ) {
		...
		$html = mkd_core_get_shortcode_module_template_part( 'templates/clients-carousel-item', 'clients-carousel', '', $params );
