...
if ( ! function_exists( 'mkd_core_set_accordion_custom_style_for_vc_shortcodes' ) ) {
	/**
	 * Function that set custom css style for accordion shortcode
	 */
	function mkd_core_set_accordion_custom_style_for_vc_shortcodes( $style ) {
		$current_style = '.vc_shortcodes_container.wpb_mkd_accordion_tab { 
	...
	add_filter( 'mkd_core_filter_add_vc_shortcodes_custom_style', 'mkd_core_set_accordion_custom_style_for_vc_shortcodes' );
}

if ( ! function_exists( 'mkd_core_set_accordion_icon_class_name_for_vc_shortcodes' ) ) {
	/**
	 * Function that set custom icon class name for accordion shortcode to set our icon for Visual Composer shortcodes panel
	 */
	function mkd_core_set_accordion_icon_class_name_for_vc_shortcodes( $shortcodes_icon_class_array ) {
	...
	add_filter( 'mkd_core_filter_add_vc_shortcodes_custom_icon_class', 'mkd_core_set_accordion_icon_class_name_for_vc_shortcodes' );
}