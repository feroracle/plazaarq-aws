...
class CallToAction implements Lib\ShortcodeInterface {
	...
	private function getHolderClasses( $params ) {
		...
		$holderClasses[] = ! empty( $params['layout'] ) ? 'mkd-' . $params['layout'] . '-layout' : '';
		$holderClasses[] = $params['content_in_grid'] === 'yes' && $params['layout'] === 'normal' ? 'mkd-content-in-grid' : '';
	...
	private function getInnerClasses( $params ) {
		...
		$innerClasses[] = $params['layout'] === 'normal' && $params['content_in_grid'] === 'yes' ? 'mkd-grid' : '';
	...
	private function getButtonHolderStyles( $params ) {
		...
		if ( ! empty( $params['button_top_margin'] ) && $params['layout'] === 'simple' ) {
			$styles[] = 'margin-top: ' . entre_mikado_filter_px( $params['button_top_margin'] ) . 'px';
		}
