 ...
 */
?>
<div class="mkd-team main-info-on-hover <?php echo esc_attr($skin) ?>">
    <div class="mkd-team-inner">
        ...
        <?php if ($team_name !== '' || $team_position !== '' || $team_description != "") { ?>
            <div class="mkd-team-info-wrapper">
                <div class="mkd-team-info-holder">
                    <div class="mkd-team-info">
                        <?php if ($team_name !== '' || $team_position !== '') { ?>
                        <?php if ($team_position !== "") { ?>
                            <h6 class="mkd-team-position" <?php echo entre_mikado_get_inline_style($position_styles); ?>><?php echo esc_attr($team_position) ?></h6>
                        <?php } ?>
