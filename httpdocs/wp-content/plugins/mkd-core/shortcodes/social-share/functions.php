...
if ( ! function_exists( 'mkd_core_set_social_share_icon_class_name_for_vc_shortcodes' ) ) {
	/**
	 * Function that set custom icon class name for social share shortcode to set our icon for Visual Composer shortcodes panel
	 */
	function mkd_core_set_social_share_icon_class_name_for_vc_shortcodes( $shortcodes_icon_class_array ) {
		$shortcodes_icon_class_array[] = '.icon-wpb-social-share';
		
		return $shortcodes_icon_class_array;
	}
	
	add_filter( 'mkd_core_filter_add_vc_shortcodes_custom_icon_class', 'mkd_core_set_social_share_icon_class_name_for_vc_shortcodes' );
}

if ( ! function_exists( 'entre_mikado_get_social_share_html' ) ) {
	/**
	 ...
	 * @return mixed|string
	 */
	function entre_mikado_get_social_share_html( $params = array() ) {
		if ( entre_mikado_core_plugin_installed() ) {
			return entre_mikado_execute_shortcode( 'mkd_social_share', $params );
		}
	}
}

if ( ! function_exists( 'entre_mikado_the_excerpt_max_charlength' ) ) {
	/**
	 ...
	 */
	function entre_mikado_the_excerpt_max_charlength( $charlength ) {
		$twitter_via_meta = entre_mikado_options()->getOptionValue( 'twitter_via' );
