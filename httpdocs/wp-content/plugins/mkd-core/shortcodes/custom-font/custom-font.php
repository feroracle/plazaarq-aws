...
class CustomFont implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Mikado Custom Font', 'mkd-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							'type'       => 'textfield',
							'param_name' => 'title',
							'heading'    => esc_html__( 'Title Text', 'mkd-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type_out_effect',
							'heading'     => esc_html__( 'Enable Type Out Effect', 'mkd-core' ),
							'description' => esc_html__( 'Adds a type out effect inside custom font content', 'mkd-core' ),
							'value'       => array_flip( entre_mikado_get_yes_no_select_array( false ) )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'type_out_position',
							'heading'     => esc_html__( 'Position of Type Out Effect', 'mkd-core' ),
							'description' => esc_html__( 'Enter the position of the word after which you would like to display type out effect (e.g. if you would like the type out effect after the 3rd word, you would enter "3")', 'mkd-core' ),
							'dependency'  => array( 'element' => 'type_out_effect', 'value' => array( 'yes' ) )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'typed_color',
							'heading'    => esc_html__( 'Typed Color', 'mkd-core' ),
							'dependency' => array( 'element' => 'type_out_effect', 'value' => array( 'yes' ) )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'typed_ending_1',
							'heading'    => esc_html__( 'Typed Ending Number 1', 'mkd-core' ),
							'dependency' => Array( 'element' => 'type_out_effect', 'value' => array( 'yes' ) )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'typed_ending_2',
							'heading'    => esc_html__( 'Typed Ending Number 2', 'mkd-core' ),
							'dependency' => array( 'element' => 'typed_ending_1', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'typed_ending_3',
							'heading'    => esc_html__( 'Typed Ending Number 3', 'mkd-core' ),
							'dependency' => array( 'element' => 'typed_ending_2', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'typed_ending_4',
							'heading'    => esc_html__( 'Typed Ending Number 4', 'mkd-core' ),
							'dependency' => array( 'element' => 'typed_ending_3', 'not_empty' => true )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'title_break_words',
							'heading'     => esc_html__( 'Position of Line Break', 'mkd-core' ),
							'description' => esc_html__( 'Enter the positions of the words after which you would like to create a line break (e.g. if you would like the line break after the 3rd and 8th words, you would enter "3,8")', 'mkd-core' ),
							'dependency'  => array( 'element' => 'title', 'not_empty' => true )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'disable_break_words',
							'heading'     => esc_html__( 'Disable Line Break for Smaller Screens', 'mkd-core' ),
							'value'       => array_flip( entre_mikado_get_yes_no_select_array( false ) ),
							'save_always' => true,
						...
						array(
							...
							'value'       => array_flip( entre_mikado_get_title_tag( true, array( 'p' => 'p' ) ) ),
							'save_always' => true
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'font_family',
							'heading'    => esc_html__( 'Font Family', 'mkd-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'font_size',
							'heading'    => esc_html__( 'Font Size (px or em)', 'mkd-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'line_height',
							'heading'    => esc_html__( 'Line Height (px or em)', 'mkd-core' )
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'heading'     => esc_html__( 'Font Style', 'mkd-core' ),
							'value'       => array_flip( entre_mikado_get_font_style_array( true ) ),
							'save_always' => true
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'letter_spacing',
							'heading'    => esc_html__( 'Letter Spacing (px or em)', 'mkd-core' )
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'heading'     => esc_html__( 'Text Decoration', 'mkd-core' ),
							'value'       => array_flip( entre_mikado_get_text_decorations( true ) ),
							'save_always' => true
						),
						array(
							'type'       => 'colorpicker',
						...
						array(
							...
							'value'       => array(
								...
								esc_html__( 'Justify', 'mkd-core' ) => 'justify'
							),
							'save_always' => true
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'margin',
							'heading'     => esc_html__( 'Margin (px or %)', 'mkd-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Font Size (px or em)', 'mkd-core' ),
							'group'      => esc_html__( 'Small Laptops', 'mkd-core' )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Font Size (px or em)', 'mkd-core' ),
							'group'      => esc_html__( 'Tablets Landscape', 'mkd-core' )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Font Size (px or em)', 'mkd-core' ),
							'group'      => esc_html__( 'Tablets Portrait', 'mkd-core' )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Font Size (px or em)', 'mkd-core' ),
							'group'      => esc_html__( 'Mobiles', 'mkd-core' )
						),
						array(
							'type'       => 'textfield',
	...
	public function render( $atts, $content = null ) {
		...
		$params['holder_rand_class'] = 'mkd-cf-' . mt_rand( 1000, 10000 );
		...
		$html = mkd_core_get_shortcode_module_template_part( 'templates/custom-font', 'custom-font', '', $params );
	...
	private function getHolderClasses( $params ) {
		...
		$holderClasses[] = $params['type_out_effect'] === 'yes' ? 'mkd-cf-has-type-out' : '';
		$holderClasses[] = $params['disable_break_words'] === 'yes' ? 'mkd-disable-title-break' : '';
	...
	private function getHolderStyles( $params ) {
		...
		if ( ! empty( $params['font_size'] ) ) {
			if ( entre_mikado_string_ends_with( $params['font_size'], 'px' ) || entre_mikado_string_ends_with( $params['font_size'], 'em' ) ) {
		...
		if ( ! empty( $params['line_height'] ) ) {
			if ( entre_mikado_string_ends_with( $params['line_height'], 'px' ) || entre_mikado_string_ends_with( $params['line_height'], 'em' ) ) {
		...
		if ( ! empty( $params['letter_spacing'] ) ) {
			if ( entre_mikado_string_ends_with( $params['letter_spacing'], 'px' ) || entre_mikado_string_ends_with( $params['letter_spacing'], 'em' ) ) {
	...
	private function getHolderData( $params ) {
		...
		if ( $params['font_size_1280'] !== '' ) {
			if ( entre_mikado_string_ends_with( $params['font_size_1280'], 'px' ) || entre_mikado_string_ends_with( $params['font_size_1280'], 'em' ) ) {
		...
		if ( $params['font_size_1024'] !== '' ) {
			if ( entre_mikado_string_ends_with( $params['font_size_1024'], 'px' ) || entre_mikado_string_ends_with( $params['font_size_1024'], 'em' ) ) {
		...
		if ( $params['font_size_768'] !== '' ) {
			if ( entre_mikado_string_ends_with( $params['font_size_768'], 'px' ) || entre_mikado_string_ends_with( $params['font_size_768'], 'em' ) ) {
		...
		if ( $params['font_size_680'] !== '' ) {
			if ( entre_mikado_string_ends_with( $params['font_size_680'], 'px' ) || entre_mikado_string_ends_with( $params['font_size_680'], 'em' ) ) {
		...
		if ( $params['line_height_1280'] !== '' ) {
			if ( entre_mikado_string_ends_with( $params['line_height_1280'], 'px' ) || entre_mikado_string_ends_with( $params['line_height_1280'], 'em' ) ) {
		...
		if ( $params['line_height_1024'] !== '' ) {
			if ( entre_mikado_string_ends_with( $params['line_height_1024'], 'px' ) || entre_mikado_string_ends_with( $params['line_height_1024'], 'em' ) ) {
		...
		if ( $params['line_height_768'] !== '' ) {
			if ( entre_mikado_string_ends_with( $params['line_height_768'], 'px' ) || entre_mikado_string_ends_with( $params['line_height_768'], 'em' ) ) {
		...
		if ( $params['line_height_680'] !== '' ) {
			if ( entre_mikado_string_ends_with( $params['line_height_680'], 'px' ) || entre_mikado_string_ends_with( $params['line_height_680'], 'em' ) ) {
	...
	private function getModifiedTitle( $params ) {
		...
		if ( ! empty( $title ) && ( $type_out_effect === 'yes' || ! empty( $title_break_words ) ) ) {
			...
			if ( $type_out_effect === 'yes' && ! empty( $type_out_position ) ) {
				...
				$typed_html = '<span class="mkd-cf-typed-wrap" ' . entre_mikado_get_inline_style( $typed_styles ) . '><span class="mkd-cf-typed">';
				if ( ! empty( $typed_ending_1 ) ) {
					$typed_html .= '<span class="mkd-cf-typed-1">' . esc_html( $typed_ending_1 ) . '</span>';
				}
				if ( ! empty( $typed_ending_2 ) ) {
					$typed_html .= '<span class="mkd-cf-typed-2">' . esc_html( $typed_ending_2 ) . '</span>';
				}
				if ( ! empty( $typed_ending_3 ) ) {
					$typed_html .= '<span class="mkd-cf-typed-3">' . esc_html( $typed_ending_3 ) . '</span>';
				}
				if ( ! empty( $typed_ending_4 ) ) {
					$typed_html .= '<span class="mkd-cf-typed-4">' . esc_html( $typed_ending_4 ) . '</span>';
				}
