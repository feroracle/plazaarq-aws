...
class UncoveringSectionsItem implements Lib\ShortcodeInterface {
	...
	function __construct() {
		$this->base = 'mkd_uncovering_sections_item';
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'            => esc_html__( 'Mikado Uncovering Sections Item', 'select-core' ),
					'base'            => $this->base,
					'as_child'        => array( 'only' => 'mkd_uncovering_sections' ),
					'as_parent'       => array( 'except' => 'vc_row, vc_accordion' ),
					'category'        => esc_html__( 'by MIKADO', 'select-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		$rand_class = 'mkd-uss-custom-' . mt_rand(100000,1000000);
		...
		$html = mkd_core_get_shortcode_module_template_part( 'templates/uncovering-sections-item', 'uncovering-sections', '', $params );
	...
	private function getHolderClasses( $params ) {
		...
		$holderClasses[] = ! empty( $params['vertical_alignment'] ) ? 'mkd-uss-item-va-' . $params['vertical_alignment'] : '';
		$holderClasses[] = ! empty( $params['horizontal_alignment'] ) ? 'mkd-uss-item-ha-' . $params['horizontal_alignment'] : '';
		$holderClasses[] = ! empty( $params['link'] ) ? 'mkd-uss-item-has-link' : '';
		$holderClasses[] = ! empty( $params['header_skin'] ) ? 'mkd-uss-item-has-style' : '';
