...
class SplitSection implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Mikado Split Section', 'mkd-core' ),
					'base'     => $this->base,
					...
					'params'   => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Image Position', 'mkd-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Text Top Margin (px or %)', 'mkd-core' ),
							'dependency' => array( 'element' => 'text', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'value'       => array(
								...
								esc_html__( 'Text', 'mkd-core' )    => 'simple'
							),
							'save_always' => true,
						...
						array(
							...
							'heading'    => esc_html__( 'Button Top Margin (px or %)', 'mkd-core' ),
							'dependency' => array( 'element' => 'button_text', 'not_empty' => true ),
							'group'      => esc_html__( 'Button Style', 'mkd-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Responsive Breakpoint', 'mkd-core' ),
							'value'       => array(
								esc_html__( 'Never', 'mkd-core' )        => '',
							...
							'description' => esc_html__( 'Choose on which stage you want to break image and text content to be one under other', 'mkd-core' ),
							'save_always' => true
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = mkd_core_get_shortcode_module_template_part( 'templates/split-section', 'split-section', '', $params );
	...
	private function getHolderClasses( $params ) {
		...
		$holderClasses[] = 'mkd-ss-image-' . $params['image_position'];
		$holderClasses[] = ! empty( $params['breakpoint'] ) ? 'mkd-ss-break-' . $params['breakpoint'] : '';
	...
	private function getTextStyles( $params ) {
		...
		if ( $params['text_top_margin'] !== '' ) {
			if ( entre_mikado_string_ends_with( $params['text_top_margin'], '%' ) || entre_mikado_string_ends_with( $params['text_top_margin'], 'px' ) ) {
