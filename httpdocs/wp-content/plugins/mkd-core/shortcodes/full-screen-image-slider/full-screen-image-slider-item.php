<?php
namespace MikadoCore\CPT\Shortcodes\FullScreenImageSlider;
...
class FullScreenImageSliderItem implements Lib\ShortcodeInterface {
	...
	function __construct() {
		$this->base = 'mkd_full_screen_image_slider_item';
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'      => esc_html__( 'Mikado Full Screen Image Slider Item', 'mkd-core' ),
					'base'      => $this->base,
					'category'  => esc_html__( 'by MIKADO', 'mkd-core' ),
					'as_child'  => array( 'only' => 'mkd_full_screen_image_slider' ),
					...
					'params'    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Content Image Top', 'mkd-core' ),
							'description' => esc_html__( 'Select image from media library', 'mkd-core' )
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_left',
							'heading'     => esc_html__( 'Content Image Left', 'mkd-core' ),
							'description' => esc_html__( 'Select image from media library', 'mkd-core' )
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_right',
							'heading'     => esc_html__( 'Content Image Right', 'mkd-core' ),
							'description' => esc_html__( 'Select image from media library', 'mkd-core' )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							'type'       => 'textfield',
							'param_name' => 'subtitle',
							'heading'    => esc_html__( 'Subitle', 'mkd-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'subtitle_tag',
							'heading'     => esc_html__( 'Subitle Tag', 'mkd-core' ),
							'value'       => array_flip( entre_mikado_get_title_tag( true ) ),
							'save_always' => true,
						...
						array(
							...
							'heading'    => esc_html__( 'Subitle Color', 'mkd-core' ),
							'dependency' => array( 'element' => 'subtitle', 'not_empty' => true )
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = mkd_core_get_shortcode_module_template_part( 'templates/full-screen-image-slider-item', 'full-screen-image-slider', '', $params );
