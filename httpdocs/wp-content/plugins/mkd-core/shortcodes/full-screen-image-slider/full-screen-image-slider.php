...
class FullScreenImageSlider implements Lib\ShortcodeInterface {
	...
	public function __construct() {
		$this->base = 'mkd_full_screen_image_slider';
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Mikado Full Screen Image Slider', 'mkd-core' ),
					'base'                      => $this->getBase(),
					'category'                  => esc_html__( 'by MIKADO', 'mkd-core' ),
					'as_parent'                 => array( 'only' => 'mkd_full_screen_image_slider_item' ),
	...
	public function render( $atts, $content = null ) {
		...
		$html = mkd_core_get_shortcode_module_template_part( 'templates/full-screen-image-slider', 'full-screen-image-slider', '', $params );
