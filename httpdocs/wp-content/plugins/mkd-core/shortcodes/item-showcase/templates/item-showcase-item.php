<div class="mkd-is-item <?php echo esc_attr($showcase_item_class); ?>">
	<div class="mkd-is-content">
		<?php if (!empty($item_title)) { ?>
			<<?php echo esc_attr($item_title_tag); ?> class="mkd-is-title" <?php echo entre_mikado_get_inline_style($item_title_styles); ?>>
		...
		<?php if (!empty($item_text)) { ?>
			<p class="mkd-is-text" <?php echo entre_mikado_get_inline_style($item_text_styles); ?>><?php echo esc_html($item_text); ?></p>
		<?php } ?>
	</div>
</div>