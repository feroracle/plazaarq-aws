<?php
namespace MikadoCore\CPT\Shortcodes\SplitScrollingSectionRightPanel;
...
class SplitScrollingSectionRightPanel implements Lib\ShortcodeInterface {
	...
	function __construct() {
		$this->base = 'mkd_split_scrolling_section_right_panel';
	...
	public function vcMap() {
		vc_map(
			array(
				'name' => esc_html__('Mikado Right Scrolling Panel', 'mkd-core'),
				'base' => $this->base,
	...
	public function render($atts, $content = null) {
		...
		$html = '<div class="mkd-sss-ms-right">';
