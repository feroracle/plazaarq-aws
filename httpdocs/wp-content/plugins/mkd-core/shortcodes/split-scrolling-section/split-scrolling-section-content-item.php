<?php
namespace MikadoCore\CPT\Shortcodes\SplitScrollingSectionContentItem;
...
class SplitScrollingSectionContentItem implements Lib\ShortcodeInterface {
	...
	function __construct() {
		$this->base = 'mkd_split_scrolling_section_content_item';
	...
	public function vcMap() {
		vc_map( array(
			'name' => esc_html__('Mikado Split Scroling Section Content Item', 'mkd-core'),
			'base' => $this->base,
			'icon' => 'icon-wpb-split-scrolling-section-content-item extended-custom-icon',
			'category' => esc_html__('by MIKADO', 'mkd-core'),
			'as_parent' => array('except' => 'vc_row'),
			'as_child' => array('only' => 'mkd_split_scrolling_section_left_panel, mkd_split_scrolling_section_right_panel'),
			...
			'params' => array(
				...
				array(
					...
					'description' => esc_html__('Insert padding in format: Top Right Bottom Left (e.g. 0px 0px 1px 0px)', 'mkd-core')
				),
				array(
					'type'       => 'dropdown',
					'param_name' =>	'alignment',
					'heading'    => esc_html__('Content Alignment', 'mkd-core'),
					'value'      => array(
				...
				array(
					...
					'heading'    => esc_html__('Header/Bullets Style', 'mkd-core'),
					'value'      => array(
						esc_html__('Default', 'mkd-core') => '',
	...
	public function render($atts, $content = null) {
		...
		$html = mkd_core_get_shortcode_module_template_part('templates/split-scrolling-section-content-item-template', 'split-scrolling-section', '', $params);
