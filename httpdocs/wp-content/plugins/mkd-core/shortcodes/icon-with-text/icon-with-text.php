...
class IconWithText implements Lib\ShortcodeInterface {
			...
			vc_map(
				array(
					...
					'params'                    => array_merge(
						...
						entre_mikado_icon_collections()->getVCParamsArray(),
						array(
							array(
								'type'       => 'attach_image',
							...
							array(
								...
								'dependency' => array(
									'element' => 'icon_type',
									'value'   => array( 'mkd-square', 'mkd-circle' )
								),
								'group'      => esc_html__( 'Icon Settings', 'mkd-core' )
							),
							array(
	...
	private function getIconParameters( $params ) {
		...
		if ( empty( $params['custom_icon'] ) ) {
			...
			if ( ! empty( $params['custom_icon_size'] ) ) {
				$params_array['custom_size'] = entre_mikado_filter_px( $params['custom_icon_size'] ) . 'px';
			}
			...
			if ( ! empty( $params['shape_size'] ) ) {
				$params_array['shape_size'] = entre_mikado_filter_px( $params['shape_size'] ) . 'px';
			}
			...
			if ( $params['icon_border_width'] !== '' ) {
				$params_array['border_width'] = entre_mikado_filter_px( $params['icon_border_width'] ) . 'px';
			}
	...
	private function getHolderClasses( $params ) {
		$holderClasses = array( 'mkd-iwt', 'clearfix' );
		
		$holderClasses[] = ! empty( $params['custom_class'] ) ? esc_attr( $params['custom_class'] ) : '';
		$holderClasses[] = ! empty( $params['type'] ) ? 'mkd-iwt-' . $params['type'] : '';
		$holderClasses[] = ! empty( $params['icon_size'] ) ? 'mkd-iwt-' . str_replace( 'mkd-', '', $params['icon_size'] ) : '';
	...
	private function getContentStyles( $params ) {
		...
		if ( $params['text_padding'] !== '' && $params['type'] === 'icon-left' ) {
			$styles[] = 'padding-left: ' . entre_mikado_filter_px( $params['text_padding'] ) . 'px';
		}
		
		if ( $params['text_padding'] !== '' && $params['type'] === 'icon-top' ) {
			$styles[] = 'padding-top: ' . entre_mikado_filter_px( $params['text_padding'] ) . 'px';
		}
	...
	private function getTextStyles( $params ) {
		...
		if ( $params['text_top_margin'] !== '' ) {
			$styles[] = 'margin-top: ' . entre_mikado_filter_px( $params['text_top_margin'] ) . 'px';
		}
