...
class ElementsHolderItem implements Lib\ShortcodeInterface {
				...
				array(
					...
					'params'                  => array(
						...
						array(
							...
							'description' => esc_html__( 'Please insert padding in format top right bottom left. For example 10px 0 10px 0', 'mkd-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size between 680px-768px', 'mkd-core' ),
							'description' => esc_html__( 'Please insert padding in format 0px 10px 0px 10px', 'mkd-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'mkd-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size bellow 680px', 'mkd-core' ),
							'description' => esc_html__( 'Please insert padding in format 0px 10px 0px 10px', 'mkd-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'mkd-core' )
						)
					)
	...
	public function render( $atts, $content = null ) {
		...
		$params['holder_rand_class'] = 'mkd-eh-custom-' . mt_rand( 1000, 10000 );
	...
	private function getHolderClasses( $params ) {
		...
		$holderClasses[] = ! empty( $params['vertical_alignment'] ) ? 'mkd-vertical-alignment-' . $params['vertical_alignment'] : '';
		$holderClasses[] = ! empty( $params['horizontal_alignment'] ) ? 'mkd-horizontal-alignment-' . $params['horizontal_alignment'] : '';
