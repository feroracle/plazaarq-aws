...
class ElementsHolder implements Lib\ShortcodeInterface {
				...
				array(
					...
					'params'    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Holder Full Height', 'mkd-core' ),
						...
						array(
							...
							'value'       => array(
								...
								esc_html__( 'Below 680px', 'mkd-core' )  => '680',
	...
	public function render( $atts, $content = null ) {
		...
		$html = '<div ' . entre_mikado_get_class_attribute( $holder_classes ) . ' ' . entre_mikado_get_inline_attr( $holder_styles, 'style' ) . '>';
	...
	private function getHolderClasses( $params ) {
		$holderClasses = array( 'mkd-elements-holder' );
		
		$holderClasses[] = ! empty( $params['custom_class'] ) ? esc_attr( $params['custom_class'] ) : '';
		$holderClasses[] = $params['holder_full_height'] === 'yes' ? 'mkd-eh-full-height' : '';
		$holderClasses[] = ! empty( $params['number_of_columns'] ) ? 'mkd-' . $params['number_of_columns'] : '';
		$holderClasses[] = $params['items_float_left'] !== '' ? 'mkd-ehi-float' : '';
		$holderClasses[] = ! empty( $params['switch_to_one_column'] ) ? 'mkd-responsive-mode-' . $params['switch_to_one_column'] : 'mkd-responsive-mode-768';
		$holderClasses[] = ! empty( $params['alignment_one_column'] ) ? 'mkd-one-column-alignment-' . $params['alignment_one_column'] : '';
