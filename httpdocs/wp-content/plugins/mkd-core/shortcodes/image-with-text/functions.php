...
if ( ! function_exists( 'mkd_core_set_image_with_text_icon_class_name_for_vc_shortcodes' ) ) {
	/**
	 ...
	 */
	function mkd_core_set_image_with_text_icon_class_name_for_vc_shortcodes( $shortcodes_icon_class_array ) {
		$shortcodes_icon_class_array[] = '.icon-wpb-image-with-text';
		
		return $shortcodes_icon_class_array;
	}
	
	add_filter( 'mkd_core_filter_add_vc_shortcodes_custom_icon_class', 'mkd_core_set_image_with_text_icon_class_name_for_vc_shortcodes' );
}