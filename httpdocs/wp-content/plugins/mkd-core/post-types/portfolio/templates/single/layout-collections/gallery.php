<?php
$gallery_classes = '';
$number_of_columns = entre_mikado_get_meta_field_intersect('portfolio_single_gallery_columns_number');
if(!empty($number_of_columns)) {
	$gallery_classes .= ' mkd-ps-'.$number_of_columns.'-columns';
}
$space_between_items = entre_mikado_get_meta_field_intersect('portfolio_single_gallery_space_between_items');
if(!empty($space_between_items)) {
	$gallery_classes .= ' mkd-'.$space_between_items.'-space';
}
?>
<div class="mkd-ps-image-holder mkd-ps-gallery-images mkd-disable-bottom-space <?php echo esc_attr($gallery_classes); ?>">
