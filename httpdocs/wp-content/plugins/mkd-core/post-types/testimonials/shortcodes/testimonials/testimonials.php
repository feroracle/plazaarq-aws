...
class Testimonials implements Lib\ShortcodeInterface {
				...
				array(
					...
					'params'                    => array(
						...
						array(
							'type'       => 'textfield',
							'param_name' => 'number',
							'heading'    => esc_html__( 'Number of Testimonials', 'mkd-core' )
						),
						array(
							'type'        => 'autocomplete',
							'param_name'  => 'category',
	...
	public function render( $atts, $content = null ) {
		...
		$html = '<div class="mkd-testimonials-holder ' . $holder_classes . ' clearfix">';
			$html .= '<div class="mkd-separator-top-line"></div>';
			$html .= '<div class="mkd-cover-box"></div>';
			$html .= '<div class="mkd-author-separator-line"></div>';
			$html .= '<div class="mkd-testimonials mkd-owl-slider" ' . entre_mikado_get_inline_attrs( $data_attr ) . '>';
			...
			if ( $query_results->have_posts() ):
				while ( $query_results->have_posts() ) : $query_results->the_post();
					...
					$position = get_post_meta( get_the_ID(), 'mkd_testimonial_author_position', true );
					...
					$html .= mkd_core_get_cpt_shortcode_module_template_part( 'testimonials', 'testimonials', 'testimonials-' . $params['type'], '', $params );
	...
	private function getHolderClasses( $params ) {
		...
		$holderClasses[] = ! empty( $params['skin'] ) ? 'mkd-testimonials-' . $params['skin'] : '';
